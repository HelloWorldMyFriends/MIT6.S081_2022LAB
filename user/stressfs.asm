...
main(int argc, char *argv[])
{
  ...
  1a:	8ca78793          	addi	a5,a5,-1846 # 8e0 <malloc+0x11e>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	88450513          	addi	a0,a0,-1916 # 8b0 <malloc+0xee>
  ...
  6c:	86050513          	addi	a0,a0,-1952 # 8c8 <malloc+0x106>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	82250513          	addi	a0,a0,-2014 # 8d8 <malloc+0x116>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48a:	4ca50513          	addi	a0,a0,1226 # 950 <digits>
 48e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 58e:	36e70713          	addi	a4,a4,878 # 8f8 <malloc+0x136>
 ...
 618:	33cb8b93          	addi	s7,s7,828 # 950 <digits>
 ...
 66c:	28890913          	addi	s2,s2,648 # 8f0 <malloc+0x12e>
        while(*s != 0){
