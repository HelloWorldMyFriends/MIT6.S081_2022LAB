...
main(int argc, char *argv[])
{
  ...
  14:	87058593          	addi	a1,a1,-1936 # 880 <statistics+0x94>
  18:	4509                	li	a0,2
  ...
  50:	84c58593          	addi	a1,a1,-1972 # 898 <statistics+0xac>
  54:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d2:	3ea70713          	addi	a4,a4,1002 # 8b8 <statistics+0xcc>
 ...
 5b0:	30490913          	addi	s2,s2,772 # 8b0 <statistics+0xc4>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 806:	12650513          	addi	a0,a0,294 # 928 <digits+0x18>
 80a:	00000097          	auipc	ra,0x0
 80e:	b1c080e7          	jalr	-1252(ra) # 326 <open>
  if(fd < 0) {
 812:	04054263          	bltz	a0,856 <statistics+0x6a>
 816:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 818:	4481                	li	s1,0
 81a:	03205063          	blez	s2,83a <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 81e:	4099063b          	subw	a2,s2,s1
 822:	009a05b3          	add	a1,s4,s1
 826:	854e                	mv	a0,s3
 828:	00000097          	auipc	ra,0x0
 82c:	ad6080e7          	jalr	-1322(ra) # 2fe <read>
 830:	00054563          	bltz	a0,83a <statistics+0x4e>
      break;
    }
    i += n;
 834:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 836:	ff24c4e3          	blt	s1,s2,81e <statistics+0x32>
  }
  close(fd);
 83a:	854e                	mv	a0,s3
 83c:	00000097          	auipc	ra,0x0
 840:	ad2080e7          	jalr	-1326(ra) # 30e <close>
  return i;
}
 844:	8526                	mv	a0,s1
 ...
 85a:	0e258593          	addi	a1,a1,226 # 938 <digits+0x28>
 85e:	4509                	li	a0,2
 860:	00000097          	auipc	ra,0x0
 864:	dc0080e7          	jalr	-576(ra) # 620 <fprintf>
      exit(1);
 868:	4505                	li	a0,1
 86a:	00000097          	auipc	ra,0x0
 86e:	a7c080e7          	jalr	-1412(ra) # 2e6 <exit>
