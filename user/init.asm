...
main(void)
{
  ...
  12:	89250513          	addi	a0,a0,-1902 # 8a0 <malloc+0xf2>
  ...
  3a:	87290913          	addi	s2,s2,-1934 # 8a8 <malloc+0xfa>
  3e:	854a                	mv	a0,s2
  ...
  6e:	88e50513          	addi	a0,a0,-1906 # 8f8 <malloc+0x14a>
  ...
  9e:	80650513          	addi	a0,a0,-2042 # 8a0 <malloc+0xf2>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	81450513          	addi	a0,a0,-2028 # 8c0 <malloc+0x112>
  ...
  d2:	80a50513          	addi	a0,a0,-2038 # 8d8 <malloc+0x12a>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	80250513          	addi	a0,a0,-2046 # 8e0 <malloc+0x132>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 476:	50650513          	addi	a0,a0,1286 # 978 <digits>
 47a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 57a:	3aa70713          	addi	a4,a4,938 # 920 <malloc+0x172>
 ...
 604:	378b8b93          	addi	s7,s7,888 # 978 <digits>
 ...
 658:	2c490913          	addi	s2,s2,708 # 918 <malloc+0x16a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7fe:	81690913          	addi	s2,s2,-2026 # 1010 <freep>
  if(p == (char*)-1)
 802:	5afd                	li	s5,-1
