...
err(char *why)
{
  ...
  28:	99c50513          	addi	a0,a0,-1636 # 9c0 <malloc+0xf0>
...
ugetpid_test()
{
  ...
  4c:	9a050513          	addi	a0,a0,-1632 # 9e8 <malloc+0x118>
  50:	00000097          	auipc	ra,0x0
  54:	7c8080e7          	jalr	1992(ra) # 818 <printf>
  testname = "ugetpid_test";
  58:	00001797          	auipc	a5,0x1
  5c:	9a878793          	addi	a5,a5,-1624 # a00 <malloc+0x130>
  ...
  94:	99050513          	addi	a0,a0,-1648 # a20 <malloc+0x150>
  ...
  ce:	94650513          	addi	a0,a0,-1722 # a10 <malloc+0x140>
...
pgaccess_test()
{
  ...
  f2:	94a50513          	addi	a0,a0,-1718 # a38 <malloc+0x168>
  f6:	00000097          	auipc	ra,0x0
  fa:	722080e7          	jalr	1826(ra) # 818 <printf>
  testname = "pgaccess_test";
  fe:	00001797          	auipc	a5,0x1
 102:	95278793          	addi	a5,a5,-1710 # a50 <malloc+0x180>
 ...
 18c:	90850513          	addi	a0,a0,-1784 # a90 <malloc+0x1c0>
 ...
 1a6:	8be50513          	addi	a0,a0,-1858 # a60 <malloc+0x190>
 1aa:	00000097          	auipc	ra,0x0
 1ae:	e56080e7          	jalr	-426(ra) # 0 <err>
    err("pgaccess failed");
 1b2:	00001517          	auipc	a0,0x1
 1b6:	8ae50513          	addi	a0,a0,-1874 # a60 <malloc+0x190>
 1ba:	00000097          	auipc	ra,0x0
 1be:	e46080e7          	jalr	-442(ra) # 0 <err>
    err("incorrect access bits set");
 1c2:	00001517          	auipc	a0,0x1
 1c6:	8ae50513          	addi	a0,a0,-1874 # a70 <malloc+0x1a0>
...
00000000000001d2 <main>:
{
 ...
 1ee:	8be50513          	addi	a0,a0,-1858 # aa8 <malloc+0x1d8>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 598:	59c50513          	addi	a0,a0,1436 # b30 <digits>
 59c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 63a:	18090c63          	beqz	s2,7d2 <vprintf+0x1b4>
 63e:	8aaa                	mv	s5,a0
 640:	8bb2                	mv	s7,a2
 ...
 64c:	4b55                	li	s6,21
 64e:	a839                	j	66c <vprintf+0x4e>
        putc(fd, c);
 650:	85ca                	mv	a1,s2
 652:	8556                	mv	a0,s5
 654:	00000097          	auipc	ra,0x0
 658:	efc080e7          	jalr	-260(ra) # 550 <putc>
 65c:	a019                	j	662 <vprintf+0x44>
    } else if(state == '%'){
 65e:	01498d63          	beq	s3,s4,678 <vprintf+0x5a>
  for(i = 0; fmt[i]; i++){
 662:	0485                	addi	s1,s1,1
 664:	fff4c903          	lbu	s2,-1(s1)
 668:	16090563          	beqz	s2,7d2 <vprintf+0x1b4>
    if(state == 0){
 66c:	fe0999e3          	bnez	s3,65e <vprintf+0x40>
      if(c == '%'){
 670:	ff4910e3          	bne	s2,s4,650 <vprintf+0x32>
        state = '%';
 674:	89d2                	mv	s3,s4
 676:	b7f5                	j	662 <vprintf+0x44>
      if(c == 'd'){
 678:	13490263          	beq	s2,s4,79c <vprintf+0x17e>
 67c:	f9d9079b          	addiw	a5,s2,-99
 680:	0ff7f793          	zext.b	a5,a5
 684:	12fb6563          	bltu	s6,a5,7ae <vprintf+0x190>
 688:	f9d9079b          	addiw	a5,s2,-99
 68c:	0ff7f713          	zext.b	a4,a5
 690:	10eb6f63          	bltu	s6,a4,7ae <vprintf+0x190>
 694:	00271793          	slli	a5,a4,0x2
 698:	00000717          	auipc	a4,0x0
 69c:	44070713          	addi	a4,a4,1088 # ad8 <malloc+0x208>
 ...
 6ba:	ebc080e7          	jalr	-324(ra) # 572 <printint>
 6be:	8bca                	mv	s7,s2
      } else {
 ...
 6d6:	ea0080e7          	jalr	-352(ra) # 572 <printint>
 6da:	8bca                	mv	s7,s2
      state = 0;
 6dc:	4981                	li	s3,0
 6de:	b751                	j	662 <vprintf+0x44>
 ...
 6f2:	e84080e7          	jalr	-380(ra) # 572 <printint>
 6f6:	8bca                	mv	s7,s2
      state = 0;
 6f8:	4981                	li	s3,0
 6fa:	b7a5                	j	662 <vprintf+0x44>
 ...
 726:	40eb8b93          	addi	s7,s7,1038 # b30 <digits>
 ...
 746:	8be2                	mv	s7,s8
      state = 0;
 748:	4981                	li	s3,0
 74a:	bf21                	j	662 <vprintf+0x44>
        s = va_arg(ap, char*);
 74c:	008b8993          	addi	s3,s7,8
 750:	000bb903          	ld	s2,0(s7)
        if(s == 0)
 754:	02090163          	beqz	s2,776 <vprintf+0x158>
        while(*s != 0){
 758:	00094583          	lbu	a1,0(s2)
 75c:	c9a5                	beqz	a1,7cc <vprintf+0x1ae>
          putc(fd, *s);
 75e:	8556                	mv	a0,s5
 760:	00000097          	auipc	ra,0x0
 764:	df0080e7          	jalr	-528(ra) # 550 <putc>
          s++;
 768:	0905                	addi	s2,s2,1
        while(*s != 0){
 76a:	00094583          	lbu	a1,0(s2)
 76e:	f9e5                	bnez	a1,75e <vprintf+0x140>
        s = va_arg(ap, char*);
 770:	8bce                	mv	s7,s3
      state = 0;
 772:	4981                	li	s3,0
 774:	b5fd                	j	662 <vprintf+0x44>
          s = "(null)";
 776:	00000917          	auipc	s2,0x0
 77a:	35a90913          	addi	s2,s2,858 # ad0 <malloc+0x200>
        while(*s != 0){
 77e:	02800593          	li	a1,40
 782:	bff1                	j	75e <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
 784:	008b8913          	addi	s2,s7,8
 788:	000bc583          	lbu	a1,0(s7)
 78c:	8556                	mv	a0,s5
 78e:	00000097          	auipc	ra,0x0
 792:	dc2080e7          	jalr	-574(ra) # 550 <putc>
 796:	8bca                	mv	s7,s2
      state = 0;
 798:	4981                	li	s3,0
 79a:	b5e1                	j	662 <vprintf+0x44>
        putc(fd, c);
 79c:	02500593          	li	a1,37
 7a0:	8556                	mv	a0,s5
 7a2:	00000097          	auipc	ra,0x0
 7a6:	dae080e7          	jalr	-594(ra) # 550 <putc>
      state = 0;
 7aa:	4981                	li	s3,0
 7ac:	bd5d                	j	662 <vprintf+0x44>
        putc(fd, '%');
 7ae:	02500593          	li	a1,37
 7b2:	8556                	mv	a0,s5
 7b4:	00000097          	auipc	ra,0x0
 7b8:	d9c080e7          	jalr	-612(ra) # 550 <putc>
        putc(fd, c);
 7bc:	85ca                	mv	a1,s2
 7be:	8556                	mv	a0,s5
 ...
 7c4:	d90080e7          	jalr	-624(ra) # 550 <putc>
      state = 0;
 7c8:	4981                	li	s3,0
 7ca:	bd61                	j	662 <vprintf+0x44>
        s = va_arg(ap, char*);
 7cc:	8bce                	mv	s7,s3
      state = 0;
 7ce:	4981                	li	s3,0
 7d0:	bd49                	j	662 <vprintf+0x44>
    }
  }
}
 7d2:	60a6                	ld	ra,72(sp)
 7d4:	6406                	ld	s0,64(sp)
 7d6:	74e2                	ld	s1,56(sp)
...
free(void *ap)
{
 ...
 85c:	7b87b783          	ld	a5,1976(a5) # 1010 <freep>
...
malloc(uint nbytes)
{
 ...
 8f8:	71c53503          	ld	a0,1820(a0) # 1010 <freep>
 ...
 920:	6f490913          	addi	s2,s2,1780 # 1010 <freep>
  if(p == (char*)-1)
 924:	5afd                	li	s5,-1
 926:	a895                	j	99a <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 ...
 988:	eca080e7          	jalr	-310(ra) # 84e <free>
  return freep;
 98c:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 990:	d971                	beqz	a0,964 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 992:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 994:	4798                	lw	a4,8(a5)
 996:	fa9775e3          	bgeu	a4,s1,940 <malloc+0x70>
    if(p == freep)
 99a:	00093703          	ld	a4,0(s2)
 99e:	853e                	mv	a0,a5
 9a0:	fef719e3          	bne	a4,a5,992 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
 9a4:	8552                	mv	a0,s4
 9a6:	00000097          	auipc	ra,0x0
 9aa:	b82080e7          	jalr	-1150(ra) # 528 <sbrk>
  if(p == (char*)-1)
 9ae:	fd5518e3          	bne	a0,s5,97e <malloc+0xae>
        return 0;
 9b2:	4501                	li	a0,0
 9b4:	bf45                	j	964 <malloc+0x94>
