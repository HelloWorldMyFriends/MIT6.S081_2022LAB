...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	e42b8b93          	addi	s7,s7,-446 # 13f8 <statistics+0xfc>
  ...
  while(peek(ps, es, "<>")){
     ...
     5cc:	e1050513          	addi	a0,a0,-496 # 13d8 <statistics+0xdc>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6b4:	d5060613          	addi	a2,a2,-688 # 1400 <statistics+0x104>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6e4:	d40b0b13          	addi	s6,s6,-704 # 1420 <statistics+0x124>
  ...
  return ret;
     ...
     71e:	cee50513          	addi	a0,a0,-786 # 1408 <statistics+0x10c>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     780:	c9450513          	addi	a0,a0,-876 # 1410 <statistics+0x114>
...
000000000000079a <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ba:	c7260613          	addi	a2,a2,-910 # 1428 <statistics+0x12c>
     7be:	85ce                	mv	a1,s3
     7c0:	854a                	mv	a0,s2
...
0000000000000808 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     82a:	c0aa0a13          	addi	s4,s4,-1014 # 1430 <statistics+0x134>
  ...
  if(peek(ps, es, ";")){
     ...
     860:	bdc60613          	addi	a2,a2,-1060 # 1438 <statistics+0x13c>
     864:	85ce                	mv	a1,s3
     866:	854a                	mv	a0,s2
...
00000000000008b0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c6:	b3e60613          	addi	a2,a2,-1218 # 1400 <statistics+0x104>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f6:	b5e60613          	addi	a2,a2,-1186 # 1450 <statistics+0x154>
     8fa:	85ca                	mv	a1,s2
     8fc:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     938:	b0c50513          	addi	a0,a0,-1268 # 1440 <statistics+0x144>
     93c:	fffff097          	auipc	ra,0xfffff
     940:	71a080e7          	jalr	1818(ra) # 56 <panic>
    panic("syntax - missing )");
     944:	00001517          	auipc	a0,0x1
     948:	b1450513          	addi	a0,a0,-1260 # 1458 <statistics+0x15c>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     974:	b4870713          	addi	a4,a4,-1208 # 14b8 <statistics+0x1bc>
...
00000000000009ec <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a20:	a5460613          	addi	a2,a2,-1452 # 1470 <statistics+0x174>
     a24:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a56:	a2658593          	addi	a1,a1,-1498 # 1478 <statistics+0x17c>
     a5a:	4509                	li	a0,2
     a5c:	00000097          	auipc	ra,0x0
     a60:	6d4080e7          	jalr	1748(ra) # 1130 <fprintf>
    panic("syntax");
     a64:	00001517          	auipc	a0,0x1
     a68:	9a450513          	addi	a0,a0,-1628 # 1408 <statistics+0x10c>
...
0000000000000a74 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a88:	a0448493          	addi	s1,s1,-1532 # 1488 <statistics+0x18c>
     a8c:	4589                	li	a1,2
     a8e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b3e:	95658593          	addi	a1,a1,-1706 # 1490 <statistics+0x194>
     b42:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ede:	65650513          	addi	a0,a0,1622 # 1530 <digits>
     ee2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fe2:	4fa70713          	addi	a4,a4,1274 # 14d8 <statistics+0x1dc>
  ...
  putc(fd, 'x');
    ...
    106c:	4c8b8b93          	addi	s7,s7,1224 # 1530 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10c0:	41490913          	addi	s2,s2,1044 # 14d0 <statistics+0x1d4>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
  ...
  fd = open("statistics", O_RDONLY);
    ...
    131e:	b1c080e7          	jalr	-1252(ra) # e36 <open>
  if(fd < 0) {
  ...
  for (i = 0; i < sz; ) {
    ...
    133c:	ad6080e7          	jalr	-1322(ra) # e0e <read>
  ...
  close(fd);
    ...
    1350:	ad2080e7          	jalr	-1326(ra) # e1e <close>
  return i;
}
    1354:	8526                	mv	a0,s1
    ...
    137e:	a7c080e7          	jalr	-1412(ra) # df6 <exit>
