...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0e250513          	addi	a0,a0,226 # 6120 <statistics+0x8c>
      ...
      74:	8082                	ret
{
      ...
      84:	0c050513          	addi	a0,a0,192 # 6140 <statistics+0xac>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0b050513          	addi	a0,a0,176 # 6158 <statistics+0xc4>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0b250513          	addi	a0,a0,178 # 6178 <statistics+0xe4>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	07a50513          	addi	a0,a0,122 # 6160 <statistics+0xcc>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	08650513          	addi	a0,a0,134 # 6188 <statistics+0xf4>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	08450513          	addi	a0,a0,132 # 61b0 <statistics+0x11c>
     134:	00006097          	auipc	ra,0x6
     138:	aaa080e7          	jalr	-1366(ra) # 5bde <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	07050513          	addi	a0,a0,112 # 61b0 <statistics+0x11c>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	06c58593          	addi	a1,a1,108 # 61c0 <statistics+0x12c>
     15c:	00006097          	auipc	ra,0x6
     160:	a52080e7          	jalr	-1454(ra) # 5bae <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	04850513          	addi	a0,a0,72 # 61b0 <statistics+0x11c>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	04c58593          	addi	a1,a1,76 # 61c8 <statistics+0x134>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	01c50513          	addi	a0,a0,28 # 61b0 <statistics+0x11c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	00650513          	addi	a0,a0,6 # 61d0 <statistics+0x13c>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f7c50513          	addi	a0,a0,-132 # 61f8 <statistics+0x164>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f68a8a93          	addi	s5,s5,-152 # 61f8 <statistics+0x164>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	ef650513          	addi	a0,a0,-266 # 6208 <statistics+0x174>
     ...
     338:	ef450513          	addi	a0,a0,-268 # 6228 <statistics+0x194>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	ee250513          	addi	a0,a0,-286 # 6240 <statistics+0x1ac>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	ece98993          	addi	s3,s3,-306 # 6240 <statistics+0x1ac>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	e8250513          	addi	a0,a0,-382 # 6240 <statistics+0x1ac>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	df258593          	addi	a1,a1,-526 # 61c8 <statistics+0x134>
    ...
    printf("write failed\n");
     ...
     3f0:	e7450513          	addi	a0,a0,-396 # 6260 <statistics+0x1cc>
    ...
    exit(1);
     ...
     40a:	e4250513          	addi	a0,a0,-446 # 6248 <statistics+0x1b4>
    ...
    printf("open junk failed\n");
     ...
     424:	e2850513          	addi	a0,a0,-472 # 6248 <statistics+0x1b4>
  ...
  unlink("junk");
     ...
     448:	dfc50513          	addi	a0,a0,-516 # 6240 <statistics+0x1ac>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d20a0a13          	addi	s4,s4,-736 # 6270 <statistics+0x1dc>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c7c50513          	addi	a0,a0,-900 # 6278 <statistics+0x1e4>
     ...
     61e:	c7650513          	addi	a0,a0,-906 # 6290 <statistics+0x1fc>
     ...
     63c:	c8850513          	addi	a0,a0,-888 # 62c0 <statistics+0x22c>
     ...
     656:	c9e50513          	addi	a0,a0,-866 # 62f0 <statistics+0x25c>
     ...
     674:	c9050513          	addi	a0,a0,-880 # 6300 <statistics+0x26c>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c82a0a13          	addi	s4,s4,-894 # 6330 <statistics+0x29c>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b12a8a93          	addi	s5,s5,-1262 # 61c8 <statistics+0x134>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	bdc50513          	addi	a0,a0,-1060 # 6338 <statistics+0x2a4>
     ...
     77e:	bd650513          	addi	a0,a0,-1066 # 6350 <statistics+0x2bc>
     ...
     798:	b5c50513          	addi	a0,a0,-1188 # 62f0 <statistics+0x25c>
     ...
     7b2:	bd250513          	addi	a0,a0,-1070 # 6380 <statistics+0x2ec>
     ...
     7d0:	bcc50513          	addi	a0,a0,-1076 # 6398 <statistics+0x304>
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	99e58593          	addi	a1,a1,-1634 # 61c0 <statistics+0x12c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	97250513          	addi	a0,a0,-1678 # 61b0 <statistics+0x11c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	94650513          	addi	a0,a0,-1722 # 61b0 <statistics+0x11c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	93250513          	addi	a0,a0,-1742 # 61b0 <statistics+0x11c>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b6c58593          	addi	a1,a1,-1172 # 6428 <statistics+0x394>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	8b250513          	addi	a0,a0,-1870 # 61b0 <statistics+0x11c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a8650513          	addi	a0,a0,-1402 # 63c8 <statistics+0x334>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a8a50513          	addi	a0,a0,-1398 # 63e8 <statistics+0x354>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	a8650513          	addi	a0,a0,-1402 # 63f8 <statistics+0x364>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a8a50513          	addi	a0,a0,-1398 # 6418 <statistics+0x384>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	a5650513          	addi	a0,a0,-1450 # 63f8 <statistics+0x364>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a7050513          	addi	a0,a0,-1424 # 6430 <statistics+0x39c>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a7250513          	addi	a0,a0,-1422 # 6450 <statistics+0x3bc>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a5e50513          	addi	a0,a0,-1442 # 6470 <statistics+0x3dc>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a6e98993          	addi	s3,s3,-1426 # 6498 <statistics+0x404>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a9ea8a93          	addi	s5,s5,-1378 # 64d0 <statistics+0x43c>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	9f850513          	addi	a0,a0,-1544 # 6470 <statistics+0x3dc>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	9bc50513          	addi	a0,a0,-1604 # 6470 <statistics+0x3dc>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	99a50513          	addi	a0,a0,-1638 # 6478 <statistics+0x3e4>
    ...
    exit(1);
     ...
     b00:	9ac50513          	addi	a0,a0,-1620 # 64a8 <statistics+0x414>
     ...
     b1e:	9c650513          	addi	a0,a0,-1594 # 64e0 <statistics+0x44c>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	9d250513          	addi	a0,a0,-1582 # 6508 <statistics+0x474>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	9d650513          	addi	a0,a0,-1578 # 6528 <statistics+0x494>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	9d250513          	addi	a0,a0,-1582 # 6540 <statistics+0x4ac>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	9c050513          	addi	a0,a0,-1600 # 6560 <statistics+0x4cc>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	96e50513          	addi	a0,a0,-1682 # 6560 <statistics+0x4cc>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	92e50513          	addi	a0,a0,-1746 # 6568 <statistics+0x4d4>
    ...
    exit(1);
     ...
     c5c:	93050513          	addi	a0,a0,-1744 # 6588 <statistics+0x4f4>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	93c50513          	addi	a0,a0,-1732 # 65b0 <statistics+0x51c>
  ...
  if(unlink("big") < 0){
     ...
     ca4:	8c050513          	addi	a0,a0,-1856 # 6560 <statistics+0x4cc>
     ...
     cd0:	90450513          	addi	a0,a0,-1788 # 65d0 <statistics+0x53c>
     ...
     cee:	90e50513          	addi	a0,a0,-1778 # 65f8 <statistics+0x564>
     ...
     d0c:	90850513          	addi	a0,a0,-1784 # 6610 <statistics+0x57c>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	91450513          	addi	a0,a0,-1772 # 6638 <statistics+0x5a4>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	8fe50513          	addi	a0,a0,-1794 # 6650 <statistics+0x5bc>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	91658593          	addi	a1,a1,-1770 # 6680 <statistics+0x5ec>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8ca50513          	addi	a0,a0,-1846 # 6650 <statistics+0x5bc>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	8b450513          	addi	a0,a0,-1868 # 6650 <statistics+0x5bc>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	89e50513          	addi	a0,a0,-1890 # 6650 <statistics+0x5bc>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	90258593          	addi	a1,a1,-1790 # 66c8 <statistics+0x634>
  ...
  unlink("unlinkread");
     ...
     e32:	82250513          	addi	a0,a0,-2014 # 6650 <statistics+0x5bc>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	81250513          	addi	a0,a0,-2030 # 6660 <statistics+0x5cc>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	81e50513          	addi	a0,a0,-2018 # 6688 <statistics+0x5f4>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	82250513          	addi	a0,a0,-2014 # 66a8 <statistics+0x614>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	82e50513          	addi	a0,a0,-2002 # 66d0 <statistics+0x63c>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	83250513          	addi	a0,a0,-1998 # 66f0 <statistics+0x65c>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	83650513          	addi	a0,a0,-1994 # 6710 <statistics+0x67c>
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	74258593          	addi	a1,a1,1858 # 6680 <statistics+0x5ec>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	7da58593          	addi	a1,a1,2010 # 6738 <statistics+0x6a4>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7ca50513          	addi	a0,a0,1994 # 6730 <statistics+0x69c>
  ...
  unlink("lf1");
     ...
     f7e:	7b650513          	addi	a0,a0,1974 # 6730 <statistics+0x69c>
     f82:	00005097          	auipc	ra,0x5
     f86:	c5c080e7          	jalr	-932(ra) # 5bde <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	7a450513          	addi	a0,a0,1956 # 6730 <statistics+0x69c>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	79650513          	addi	a0,a0,1942 # 6738 <statistics+0x6a4>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	75e58593          	addi	a1,a1,1886 # 6738 <statistics+0x6a4>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	74850513          	addi	a0,a0,1864 # 6738 <statistics+0x6a4>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	be6080e7          	jalr	-1050(ra) # 5bde <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	73058593          	addi	a1,a1,1840 # 6730 <statistics+0x69c>
    1008:	00005517          	auipc	a0,0x5
    100c:	73050513          	addi	a0,a0,1840 # 6738 <statistics+0x6a4>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	71458593          	addi	a1,a1,1812 # 6730 <statistics+0x69c>
    1024:	00006517          	auipc	a0,0x6
    1028:	81c50513          	addi	a0,a0,-2020 # 6840 <statistics+0x7ac>
    ...
    104a:	6fa50513          	addi	a0,a0,1786 # 6740 <statistics+0x6ac>
    ...
    1066:	6f650513          	addi	a0,a0,1782 # 6758 <statistics+0x6c4>
    ...
    1082:	6f250513          	addi	a0,a0,1778 # 6770 <statistics+0x6dc>
    ...
    109e:	6f650513          	addi	a0,a0,1782 # 6790 <statistics+0x6fc>
    ...
    10ba:	70a50513          	addi	a0,a0,1802 # 67c0 <statistics+0x72c>
    ...
    10d6:	70650513          	addi	a0,a0,1798 # 67d8 <statistics+0x744>
    ...
    10f2:	70250513          	addi	a0,a0,1794 # 67f0 <statistics+0x75c>
    ...
    110e:	70e50513          	addi	a0,a0,1806 # 6818 <statistics+0x784>
    ...
    112a:	72250513          	addi	a0,a0,1826 # 6848 <statistics+0x7b4>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	71098993          	addi	s3,s3,1808 # 6868 <statistics+0x7d4>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	6e450513          	addi	a0,a0,1764 # 6878 <statistics+0x7e4>
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	69ea0a13          	addi	s4,s4,1694 # 6898 <statistics+0x804>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	64c50513          	addi	a0,a0,1612 # 6898 <statistics+0x804>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	5e450513          	addi	a0,a0,1508 # 68a0 <statistics+0x80c>
    ...
    12e0:	5e450513          	addi	a0,a0,1508 # 68c0 <statistics+0x82c>
    ...
    12fc:	5e850513          	addi	a0,a0,1512 # 68e0 <statistics+0x84c>
...
000000000000134a <badarg>:
{
    ...
    1368:	df498993          	addi	s3,s3,-524 # 6158 <statistics+0xc4>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	74a78793          	addi	a5,a5,1866 # 7b38 <statistics+0x1aa4>
  ...
  if(pid == 0){
    ...
    144e:	12e78793          	addi	a5,a5,302 # 8578 <statistics+0x24e4>
    ...
    1472:	cea50513          	addi	a0,a0,-790 # 6158 <statistics+0xc4>
    ...
    148a:	50250513          	addi	a0,a0,1282 # 6988 <statistics+0x8f4>
    ...
    14aa:	45a50513          	addi	a0,a0,1114 # 6900 <statistics+0x86c>
    ...
    14ca:	45a50513          	addi	a0,a0,1114 # 6920 <statistics+0x88c>
    ...
    14ec:	45850513          	addi	a0,a0,1112 # 6940 <statistics+0x8ac>
    ...
    150c:	46050513          	addi	a0,a0,1120 # 6968 <statistics+0x8d4>
    ...
    1526:	8c650513          	addi	a0,a0,-1850 # 6de8 <statistics+0xd54>
  ...
  if(st != 747){
    ...
    1570:	44450513          	addi	a0,a0,1092 # 69b0 <statistics+0x91c>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	c1250513          	addi	a0,a0,-1006 # 61b0 <statistics+0x11c>
  ...
  if(pid == 0){
    ...
    15cc:	be8a0a13          	addi	s4,s4,-1048 # 61b0 <statistics+0x11c>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	440a8a93          	addi	s5,s5,1088 # 6a10 <statistics+0x97c>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	3a050513          	addi	a0,a0,928 # 69e0 <statistics+0x94c>
    ...
    1660:	39c50513          	addi	a0,a0,924 # 69f8 <statistics+0x964>
    ...
    167e:	3a650513          	addi	a0,a0,934 # 6a20 <statistics+0x98c>
    ...
    169c:	b18a0a13          	addi	s4,s4,-1256 # 61b0 <statistics+0x11c>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	3a0a8a93          	addi	s5,s5,928 # 6a40 <statistics+0x9ac>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	ac650513          	addi	a0,a0,-1338 # 61b0 <statistics+0x11c>
  ...
  exit(xstatus);
    ...
    170c:	2f050513          	addi	a0,a0,752 # 69f8 <statistics+0x964>
    ...
    172a:	32250513          	addi	a0,a0,802 # 6a48 <statistics+0x9b4>
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	a0a78793          	addi	a5,a5,-1526 # 6158 <statistics+0xc4>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	30e78793          	addi	a5,a5,782 # 6a68 <statistics+0x9d4>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	30650513          	addi	a0,a0,774 # 6a70 <statistics+0x9dc>
  ...
  if(pid == 0) {
    ...
    179c:	2d850513          	addi	a0,a0,728 # 6a70 <statistics+0x9dc>
    ...
    17b8:	2dc50513          	addi	a0,a0,732 # 6a90 <statistics+0x9fc>
    ...
    17d4:	21050513          	addi	a0,a0,528 # 69e0 <statistics+0x94c>
    ...
    17f0:	28c50513          	addi	a0,a0,652 # 6a78 <statistics+0x9e4>
    ...
    180e:	94e50513          	addi	a0,a0,-1714 # 6158 <statistics+0xc4>
  ...
  if(xstatus != 0)
    ...
    1842:	26250513          	addi	a0,a0,610 # 6aa0 <statistics+0xa0c>
    ...
    185e:	25e50513          	addi	a0,a0,606 # 6ab8 <statistics+0xa24>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1872:	20250513          	addi	a0,a0,514 # 6a70 <statistics+0x9dc>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	c9050513          	addi	a0,a0,-880 # 6528 <statistics+0x494>
    ...
    18b8:	14450513          	addi	a0,a0,324 # 69f8 <statistics+0x964>
  ...
  unlink("echo-ok");
    ...
    18d2:	1a250513          	addi	a0,a0,418 # 6a70 <statistics+0x9dc>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	1d850513          	addi	a0,a0,472 # 6ad0 <statistics+0xa3c>
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	13050513          	addi	a0,a0,304 # 6ae8 <statistics+0xa54>
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	0c250513          	addi	a0,a0,194 # 6b00 <statistics+0xa6c>
    ...
    1a5e:	0be50513          	addi	a0,a0,190 # 6b18 <statistics+0xa84>
    ...
    1a90:	0a450513          	addi	a0,a0,164 # 6b30 <statistics+0xa9c>
    ...
    1ad0:	08450513          	addi	a0,a0,132 # 6b50 <statistics+0xabc>
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	ea250513          	addi	a0,a0,-350 # 69e0 <statistics+0x94c>
    ...
    1b5e:	00e50513          	addi	a0,a0,14 # 6b68 <statistics+0xad4>
    ...
    1b7a:	00a50513          	addi	a0,a0,10 # 6b80 <statistics+0xaec>
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	df250513          	addi	a0,a0,-526 # 69e0 <statistics+0x94c>
    ...
    1c16:	dce50513          	addi	a0,a0,-562 # 69e0 <statistics+0x94c>
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	f1450513          	addi	a0,a0,-236 # 6ba0 <statistics+0xb0c>
    ...
    1ca2:	ef0080e7          	jalr	-272(ra) # 5b8e <exit>
{
    ...
    1ce8:	ecc50513          	addi	a0,a0,-308 # 6bb0 <statistics+0xb1c>
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	0b650513          	addi	a0,a0,182 # 6de8 <statistics+0xd54>
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	01850513          	addi	a0,a0,24 # 6de8 <statistics+0xd54>
    ...
    1e00:	c7c50513          	addi	a0,a0,-900 # 6a78 <statistics+0x9e4>
    ...
    1e72:	d6250513          	addi	a0,a0,-670 # 6bd0 <statistics+0xb3c>
    ...
    1ea6:	d4650513          	addi	a0,a0,-698 # 6be8 <statistics+0xb54>
    ...
    1f0c:	d0850513          	addi	a0,a0,-760 # 6c10 <statistics+0xb7c>
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	22050513          	addi	a0,a0,544 # 61c8 <statistics+0x134>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	1e4a8a93          	addi	s5,s5,484 # 61c8 <statistics+0x134>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	c4cb8b93          	addi	s7,s7,-948 # 6c38 <statistics+0xba4>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	9e850513          	addi	a0,a0,-1560 # 69e0 <statistics+0x94c>
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	b9e50513          	addi	a0,a0,-1122 # 6c58 <statistics+0xbc4>
  ...
  if(wait(0) != -1){
    ...
    2120:	b2450513          	addi	a0,a0,-1244 # 6c40 <statistics+0xbac>
    ...
    213c:	b4850513          	addi	a0,a0,-1208 # 6c80 <statistics+0xbec>
    ...
    2158:	b4450513          	addi	a0,a0,-1212 # 6c98 <statistics+0xc04>
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	80c50513          	addi	a0,a0,-2036 # 69e0 <statistics+0x94c>
    ...
    21fa:	aba50513          	addi	a0,a0,-1350 # 6cb0 <statistics+0xc1c>
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	76850513          	addi	a0,a0,1896 # 69e0 <statistics+0x94c>
    ...
    22a8:	a2c50513          	addi	a0,a0,-1492 # 6cd0 <statistics+0xc3c>
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	a1450513          	addi	a0,a0,-1516 # 6ce8 <statistics+0xc54>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	9e250513          	addi	a0,a0,-1566 # 6ce8 <statistics+0xc54>
  ...
  close(fd);
    ...
    2340:	9bc70713          	addi	a4,a4,-1604 # 6cf8 <statistics+0xc64>
    ...
    2394:	a4850513          	addi	a0,a0,-1464 # 6dd8 <statistics+0xd44>
    ...
    23b8:	a4450513          	addi	a0,a0,-1468 # 6df8 <statistics+0xd64>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	a0650513          	addi	a0,a0,-1530 # 6e18 <statistics+0xd84>
    ...
    2432:	5b250513          	addi	a0,a0,1458 # 69e0 <statistics+0x94c>
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	54450513          	addi	a0,a0,1348 # 69e0 <statistics+0x94c>
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	8d050513          	addi	a0,a0,-1840 # 6de8 <statistics+0xd54>
    ...
    25cc:	87850513          	addi	a0,a0,-1928 # 6e40 <statistics+0xdac>
    ...
    25ec:	c4050513          	addi	a0,a0,-960 # 6228 <statistics+0x194>
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	4b878793          	addi	a5,a5,1208 # 7b38 <statistics+0x1aa4>
  ...
  if(ret != -1){
    ...
    26c6:	79650513          	addi	a0,a0,1942 # 6e58 <statistics+0xdc4>
    ...
    26e4:	22050513          	addi	a0,a0,544 # 6900 <statistics+0x86c>
    ...
    2702:	22250513          	addi	a0,a0,546 # 6920 <statistics+0x88c>
    ...
    2722:	22250513          	addi	a0,a0,546 # 6940 <statistics+0x8ac>
    ...
    2740:	22c50513          	addi	a0,a0,556 # 6968 <statistics+0x8d4>
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	71050513          	addi	a0,a0,1808 # 6e98 <statistics+0xe04>
  ...
  if(n >= 0){
    ...
    27bc:	70050513          	addi	a0,a0,1792 # 6eb8 <statistics+0xe24>
    ...
    27d6:	68e50513          	addi	a0,a0,1678 # 6e60 <statistics+0xdcc>
    ...
    27f0:	68c50513          	addi	a0,a0,1676 # 6e78 <statistics+0xde4>
    ...
    280a:	69a50513          	addi	a0,a0,1690 # 6ea0 <statistics+0xe0c>
  ...
  unlink("rwsbrk");
    ...
    282e:	66e50513          	addi	a0,a0,1646 # 6e98 <statistics+0xe04>
    2832:	00003097          	auipc	ra,0x3
    2836:	3ac080e7          	jalr	940(ra) # 5bde <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	af450513          	addi	a0,a0,-1292 # 6330 <statistics+0x29c>
  ...
  if(n >= 0){
    ...
    286a:	68250513          	addi	a0,a0,1666 # 6ee8 <statistics+0xe54>
    ...
    2884:	62050513          	addi	a0,a0,1568 # 6ea0 <statistics+0xe0c>
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	61050513          	addi	a0,a0,1552 # 6f10 <statistics+0xe7c>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	5de50513          	addi	a0,a0,1502 # 6f30 <statistics+0xe9c>
  ...
  if(c != a + 1){
    ...
    29ba:	5da50513          	addi	a0,a0,1498 # 6f90 <statistics+0xefc>
    ...
    29dc:	57850513          	addi	a0,a0,1400 # 6f50 <statistics+0xebc>
    ...
    29f8:	57c50513          	addi	a0,a0,1404 # 6f70 <statistics+0xedc>
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	47250513          	addi	a0,a0,1138 # 6fb0 <statistics+0xf1c>
    ...
    2b5e:	49e50513          	addi	a0,a0,1182 # 6ff8 <statistics+0xf64>
    ...
    2b7e:	49e50513          	addi	a0,a0,1182 # 7018 <statistics+0xf84>
    ...
    2b9e:	4be50513          	addi	a0,a0,1214 # 7058 <statistics+0xfc4>
    ...
    2bba:	4d250513          	addi	a0,a0,1234 # 7088 <statistics+0xff4>
    ...
    2bda:	4ea50513          	addi	a0,a0,1258 # 70c0 <statistics+0x102c>
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	4d850513          	addi	a0,a0,1240 # 70e8 <statistics+0x1054>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fb6080e7          	jalr	-74(ra) # 5bce <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	4c650513          	addi	a0,a0,1222 # 70e8 <statistics+0x1054>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	47a50513          	addi	a0,a0,1146 # 70f0 <statistics+0x105c>
    ...
    2c96:	47650513          	addi	a0,a0,1142 # 7108 <statistics+0x1074>
    ...
    2cb2:	e3a50513          	addi	a0,a0,-454 # 6ae8 <statistics+0xa54>
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	44850513          	addi	a0,a0,1096 # 7120 <statistics+0x108c>
  ...
  close(fd);
    ...
    2d24:	cd850513          	addi	a0,a0,-808 # 69f8 <statistics+0x964>
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	07a50513          	addi	a0,a0,122 # 6de8 <statistics+0xd54>
  ...
  if(pid == 0){
    ...
    2dc8:	02450513          	addi	a0,a0,36 # 6de8 <statistics+0xd54>
  ...
  if(pid == 0){
    ...
    2e28:	fc450513          	addi	a0,a0,-60 # 6de8 <statistics+0xd54>
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	e5050513          	addi	a0,a0,-432 # 6de8 <statistics+0xd54>
    ...
    2ff0:	16c50513          	addi	a0,a0,364 # 6158 <statistics+0xc4>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	1d078793          	addi	a5,a5,464 # 61c8 <statistics+0x134>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	2ce50513          	addi	a0,a0,718 # 72f8 <statistics+0x1264>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	11450513          	addi	a0,a0,276 # 7150 <statistics+0x10bc>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	15650513          	addi	a0,a0,342 # 71a8 <statistics+0x1114>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	1b050513          	addi	a0,a0,432 # 7220 <statistics+0x118c>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	20450513          	addi	a0,a0,516 # 7290 <statistics+0x11fc>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	24a50513          	addi	a0,a0,586 # 72e8 <statistics+0x1254>
  ...
  unlink("12345678901234");
    ...
    3120:	00c50513          	addi	a0,a0,12 # 7128 <statistics+0x1094>
    ...
    313c:	03850513          	addi	a0,a0,56 # 7170 <statistics+0x10dc>
    ...
    3158:	08450513          	addi	a0,a0,132 # 71d8 <statistics+0x1144>
    ...
    3174:	0e050513          	addi	a0,a0,224 # 7250 <statistics+0x11bc>
    ...
    3190:	12450513          	addi	a0,a0,292 # 72b0 <statistics+0x121c>
    ...
    31ac:	16050513          	addi	a0,a0,352 # 7308 <statistics+0x1274>
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	14c50513          	addi	a0,a0,332 # 7340 <statistics+0x12ac>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	13250513          	addi	a0,a0,306 # 7350 <statistics+0x12bc>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	09250513          	addi	a0,a0,146 # 7340 <statistics+0x12ac>
  ...
  unlink("diskfulldir");
    ...
    32c6:	07e50513          	addi	a0,a0,126 # 7340 <statistics+0x12ac>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	f8050513          	addi	a0,a0,-128 # 7370 <statistics+0x12dc>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	f9250513          	addi	a0,a0,-110 # 73a0 <statistics+0x130c>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	f7e50513          	addi	a0,a0,-130 # 73a0 <statistics+0x130c>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	faa50513          	addi	a0,a0,-86 # 73e0 <statistics+0x134c>
  ...
  if(chdir("/") < 0){
    ...
    344e:	fc650513          	addi	a0,a0,-58 # 7410 <statistics+0x137c>
    ...
    346e:	f3e50513          	addi	a0,a0,-194 # 73a8 <statistics+0x1314>
    ...
    348a:	f3a50513          	addi	a0,a0,-198 # 73c0 <statistics+0x132c>
    ...
    34a6:	f4e50513          	addi	a0,a0,-178 # 73f0 <statistics+0x135c>
    ...
    34c2:	f5a50513          	addi	a0,a0,-166 # 7418 <statistics+0x1384>
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	eae50513          	addi	a0,a0,-338 # 73a0 <statistics+0x130c>
    ...
    350a:	e9a50513          	addi	a0,a0,-358 # 73a0 <statistics+0x130c>
    ...
    351e:	ec650513          	addi	a0,a0,-314 # 73e0 <statistics+0x134c>
    ...
    353e:	4a650513          	addi	a0,a0,1190 # 69e0 <statistics+0x94c>
    ...
    355a:	e5250513          	addi	a0,a0,-430 # 73a8 <statistics+0x1314>
    ...
    3576:	ebe50513          	addi	a0,a0,-322 # 7430 <statistics+0x139c>
    ...
    3592:	e6250513          	addi	a0,a0,-414 # 73f0 <statistics+0x135c>
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	e7c50513          	addi	a0,a0,-388 # 7448 <statistics+0x13b4>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	e6850513          	addi	a0,a0,-408 # 7448 <statistics+0x13b4>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	e7450513          	addi	a0,a0,-396 # 7468 <statistics+0x13d4>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	e4050513          	addi	a0,a0,-448 # 7448 <statistics+0x13b4>
    ...
    362c:	d8050513          	addi	a0,a0,-640 # 73a8 <statistics+0x1314>
    ...
    3648:	e0c50513          	addi	a0,a0,-500 # 7450 <statistics+0x13bc>
    ...
    3664:	e1050513          	addi	a0,a0,-496 # 7470 <statistics+0x13dc>
    ...
    3680:	e0c50513          	addi	a0,a0,-500 # 7488 <statistics+0x13f4>
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	f2c50513          	addi	a0,a0,-212 # 75d0 <statistics+0x153c>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	532080e7          	jalr	1330(ra) # 5bde <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	dec50513          	addi	a0,a0,-532 # 74a0 <statistics+0x140c>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	df450513          	addi	a0,a0,-524 # 74c0 <statistics+0x142c>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	eec58593          	addi	a1,a1,-276 # 75d0 <statistics+0x153c>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	da250513          	addi	a0,a0,-606 # 74a0 <statistics+0x140c>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	e0650513          	addi	a0,a0,-506 # 7518 <statistics+0x1484>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	e1650513          	addi	a0,a0,-490 # 7540 <statistics+0x14ac>
  ...
  write(fd, "FF", 2);
    ...
    3746:	e2e58593          	addi	a1,a1,-466 # 7570 <statistics+0x14dc>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	e1a50513          	addi	a0,a0,-486 # 7578 <statistics+0x14e4>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	e2258593          	addi	a1,a1,-478 # 75c8 <statistics+0x1534>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	d9250513          	addi	a0,a0,-622 # 7540 <statistics+0x14ac>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	d7e50513          	addi	a0,a0,-642 # 7540 <statistics+0x14ac>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	d6850513          	addi	a0,a0,-664 # 7540 <statistics+0x14ac>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	cb450513          	addi	a0,a0,-844 # 74a0 <statistics+0x140c>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	e6050513          	addi	a0,a0,-416 # 7660 <statistics+0x15cc>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	e7c50513          	addi	a0,a0,-388 # 7690 <statistics+0x15fc>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	e9850513          	addi	a0,a0,-360 # 76c0 <statistics+0x162c>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	d8a50513          	addi	a0,a0,-630 # 75c8 <statistics+0x1534>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	cc850513          	addi	a0,a0,-824 # 7540 <statistics+0x14ac>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	ec050513          	addi	a0,a0,-320 # 7750 <statistics+0x16bc>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	ed850513          	addi	a0,a0,-296 # 7780 <statistics+0x16ec>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	be050513          	addi	a0,a0,-1056 # 74a0 <statistics+0x140c>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	bca50513          	addi	a0,a0,-1078 # 74a0 <statistics+0x140c>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	bb450513          	addi	a0,a0,-1100 # 74a0 <statistics+0x140c>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	f1058593          	addi	a1,a1,-240 # 7810 <statistics+0x177c>
    3908:	00004517          	auipc	a0,0x4
    390c:	e4850513          	addi	a0,a0,-440 # 7750 <statistics+0x16bc>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	ef458593          	addi	a1,a1,-268 # 7810 <statistics+0x177c>
    3924:	00004517          	auipc	a0,0x4
    3928:	e5c50513          	addi	a0,a0,-420 # 7780 <statistics+0x16ec>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	c9058593          	addi	a1,a1,-880 # 75c8 <statistics+0x1534>
    3940:	00004517          	auipc	a0,0x4
    3944:	b8050513          	addi	a0,a0,-1152 # 74c0 <statistics+0x142c>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	dfc50513          	addi	a0,a0,-516 # 7750 <statistics+0x16bc>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	e1850513          	addi	a0,a0,-488 # 7780 <statistics+0x16ec>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	c4c50513          	addi	a0,a0,-948 # 75c8 <statistics+0x1534>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	df050513          	addi	a0,a0,-528 # 7780 <statistics+0x16ec>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	dac50513          	addi	a0,a0,-596 # 7750 <statistics+0x16bc>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	b0850513          	addi	a0,a0,-1272 # 74c0 <statistics+0x142c>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	f9450513          	addi	a0,a0,-108 # 7960 <statistics+0x18cc>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	be850513          	addi	a0,a0,-1048 # 75c8 <statistics+0x1534>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	acc50513          	addi	a0,a0,-1332 # 74c0 <statistics+0x142c>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	a9850513          	addi	a0,a0,-1384 # 74a0 <statistics+0x140c>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	fb450513          	addi	a0,a0,-76 # 79d0 <statistics+0x193c>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	a7050513          	addi	a0,a0,-1424 # 74a0 <statistics+0x140c>
    ...
    3a56:	a5650513          	addi	a0,a0,-1450 # 74a8 <statistics+0x1414>
    ...
    3a72:	a5a50513          	addi	a0,a0,-1446 # 74c8 <statistics+0x1434>
    ...
    3a8e:	a5e50513          	addi	a0,a0,-1442 # 74e8 <statistics+0x1454>
    ...
    3aaa:	a7a50513          	addi	a0,a0,-1414 # 7520 <statistics+0x148c>
    ...
    3ac6:	a8e50513          	addi	a0,a0,-1394 # 7550 <statistics+0x14bc>
    ...
    3ae2:	aaa50513          	addi	a0,a0,-1366 # 7588 <statistics+0x14f4>
    ...
    3afe:	aae50513          	addi	a0,a0,-1362 # 75a8 <statistics+0x1514>
    ...
    3b1a:	ac250513          	addi	a0,a0,-1342 # 75d8 <statistics+0x1544>
    ...
    3b36:	ace50513          	addi	a0,a0,-1330 # 7600 <statistics+0x156c>
    ...
    3b52:	ad250513          	addi	a0,a0,-1326 # 7620 <statistics+0x158c>
    ...
    3b6e:	ade50513          	addi	a0,a0,-1314 # 7648 <statistics+0x15b4>
    ...
    3b8a:	aea50513          	addi	a0,a0,-1302 # 7670 <statistics+0x15dc>
    ...
    3ba6:	afe50513          	addi	a0,a0,-1282 # 76a0 <statistics+0x160c>
    ...
    3bc2:	b0a50513          	addi	a0,a0,-1270 # 76c8 <statistics+0x1634>
    ...
    3bde:	b0650513          	addi	a0,a0,-1274 # 76e0 <statistics+0x164c>
    ...
    3bfa:	b0a50513          	addi	a0,a0,-1270 # 7700 <statistics+0x166c>
    ...
    3c16:	b0e50513          	addi	a0,a0,-1266 # 7720 <statistics+0x168c>
    ...
    3c32:	b3250513          	addi	a0,a0,-1230 # 7760 <statistics+0x16cc>
    ...
    3c4e:	b4650513          	addi	a0,a0,-1210 # 7790 <statistics+0x16fc>
    ...
    3c6a:	b4a50513          	addi	a0,a0,-1206 # 77b0 <statistics+0x171c>
    ...
    3c86:	b4e50513          	addi	a0,a0,-1202 # 77d0 <statistics+0x173c>
    ...
    3ca2:	b5250513          	addi	a0,a0,-1198 # 77f0 <statistics+0x175c>
    ...
    3cbe:	b6650513          	addi	a0,a0,-1178 # 7820 <statistics+0x178c>
    ...
    3cda:	b7250513          	addi	a0,a0,-1166 # 7848 <statistics+0x17b4>
    ...
    3cf6:	b7e50513          	addi	a0,a0,-1154 # 7870 <statistics+0x17dc>
    ...
    3d12:	b8a50513          	addi	a0,a0,-1142 # 7898 <statistics+0x1804>
    ...
    3d2e:	b8e50513          	addi	a0,a0,-1138 # 78b8 <statistics+0x1824>
    ...
    3d4a:	b9250513          	addi	a0,a0,-1134 # 78d8 <statistics+0x1844>
    ...
    3d66:	b9e50513          	addi	a0,a0,-1122 # 7900 <statistics+0x186c>
    ...
    3d82:	ba250513          	addi	a0,a0,-1118 # 7920 <statistics+0x188c>
    ...
    3d9e:	ba650513          	addi	a0,a0,-1114 # 7940 <statistics+0x18ac>
    ...
    3dba:	bb250513          	addi	a0,a0,-1102 # 7968 <statistics+0x18d4>
    ...
    3dd6:	82e50513          	addi	a0,a0,-2002 # 7600 <statistics+0x156c>
    ...
    3df2:	b9a50513          	addi	a0,a0,-1126 # 7988 <statistics+0x18f4>
    ...
    3e0e:	b9e50513          	addi	a0,a0,-1122 # 79a8 <statistics+0x1914>
    ...
    3e2a:	bb250513          	addi	a0,a0,-1102 # 79d8 <statistics+0x1944>
    ...
    3e46:	bb650513          	addi	a0,a0,-1098 # 79f8 <statistics+0x1964>
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	ba850513          	addi	a0,a0,-1112 # 7a10 <statistics+0x197c>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	b9650513          	addi	a0,a0,-1130 # 7a10 <statistics+0x197c>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	9b450513          	addi	a0,a0,-1612 # 6840 <statistics+0x7ac>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	5ca50513          	addi	a0,a0,1482 # 7468 <statistics+0x13d4>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	56050513          	addi	a0,a0,1376 # 7410 <statistics+0x137c>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	bb650513          	addi	a0,a0,-1098 # 7a78 <statistics+0x19e4>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	bcc50513          	addi	a0,a0,-1076 # 7aa0 <statistics+0x1a0c>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	b2a50513          	addi	a0,a0,-1238 # 7a10 <statistics+0x197c>
    ...
    3f08:	b1450513          	addi	a0,a0,-1260 # 7a18 <statistics+0x1984>
    ...
    3f24:	b1050513          	addi	a0,a0,-1264 # 7a30 <statistics+0x199c>
    ...
    3f40:	b0c50513          	addi	a0,a0,-1268 # 7a48 <statistics+0x19b4>
    ...
    3f5c:	b0850513          	addi	a0,a0,-1272 # 7a60 <statistics+0x19cc>
    ...
    3f78:	4a450513          	addi	a0,a0,1188 # 7418 <statistics+0x1384>
    ...
    3f94:	af050513          	addi	a0,a0,-1296 # 7a80 <statistics+0x19ec>
    ...
    3fb0:	afc50513          	addi	a0,a0,-1284 # 7aa8 <statistics+0x1a14>
    ...
    3fcc:	b0050513          	addi	a0,a0,-1280 # 7ac8 <statistics+0x1a34>
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	af450513          	addi	a0,a0,-1292 # 7ae8 <statistics+0x1a54>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	ad850513          	addi	a0,a0,-1320 # 7ae8 <statistics+0x1a54>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	b0c50513          	addi	a0,a0,-1268 # 7b30 <statistics+0x1a9c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	af450513          	addi	a0,a0,-1292 # 7b30 <statistics+0x1a9c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	ae050513          	addi	a0,a0,-1312 # 7b30 <statistics+0x1a9c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	acc50513          	addi	a0,a0,-1332 # 7b30 <statistics+0x1a9c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	ab858593          	addi	a1,a1,-1352 # 7b30 <statistics+0x1a9c>
    4080:	00002517          	auipc	a0,0x2
    4084:	2b050513          	addi	a0,a0,688 # 6330 <statistics+0x29c>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	a5450513          	addi	a0,a0,-1452 # 7ae8 <statistics+0x1a54>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	79650513          	addi	a0,a0,1942 # 6840 <statistics+0x7ac>
  ...
  fd = open(".", 0);
    ...
    40c4:	78050513          	addi	a0,a0,1920 # 6840 <statistics+0x7ac>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	0f458593          	addi	a1,a1,244 # 61c8 <statistics+0x134>
  ...
  close(fd);
    ...
    4104:	9f050513          	addi	a0,a0,-1552 # 7af0 <statistics+0x1a5c>
    ...
    4120:	9f450513          	addi	a0,a0,-1548 # 7b10 <statistics+0x1a7c>
    ...
    413c:	a0850513          	addi	a0,a0,-1528 # 7b40 <statistics+0x1aac>
    ...
    4158:	9ec50513          	addi	a0,a0,-1556 # 7b40 <statistics+0x1aac>
    ...
    4174:	9f850513          	addi	a0,a0,-1544 # 7b68 <statistics+0x1ad4>
    ...
    4190:	a0450513          	addi	a0,a0,-1532 # 7b90 <statistics+0x1afc>
    ...
    41ac:	a1050513          	addi	a0,a0,-1520 # 7bb8 <statistics+0x1b24>
    ...
    41c8:	a1c50513          	addi	a0,a0,-1508 # 7be0 <statistics+0x1b4c>
    ...
    41e4:	a2050513          	addi	a0,a0,-1504 # 7c00 <statistics+0x1b6c>
    ...
    4200:	a2c50513          	addi	a0,a0,-1492 # 7c28 <statistics+0x1b94>
...
0000000000004216 <iref>:
{
    ...
    4234:	a10a0a13          	addi	s4,s4,-1520 # 7c40 <statistics+0x1bac>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	51048493          	addi	s1,s1,1296 # 7748 <statistics+0x16b4>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	0f0a8a93          	addi	s5,s5,240 # 6330 <statistics+0x29c>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	8f098993          	addi	s3,s3,-1808 # 7b38 <statistics+0x1aa4>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	9f450513          	addi	a0,a0,-1548 # 7c48 <statistics+0x1bb4>
    ...
    4274:	9f050513          	addi	a0,a0,-1552 # 7c60 <statistics+0x1bcc>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	16498993          	addi	s3,s3,356 # 7468 <statistics+0x13d4>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	93490913          	addi	s2,s2,-1740 # 7c40 <statistics+0x1bac>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	0e450513          	addi	a0,a0,228 # 7410 <statistics+0x137c>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	91c50513          	addi	a0,a0,-1764 # 7c78 <statistics+0x1be4>
  ...
  if(pid == 0){
    ...
    4384:	8f850513          	addi	a0,a0,-1800 # 7c78 <statistics+0x1be4>
    ...
    439a:	90250513          	addi	a0,a0,-1790 # 7c98 <statistics+0x1c04>
    ...
    43b6:	8ce50513          	addi	a0,a0,-1842 # 7c80 <statistics+0x1bec>
    ...
    43d2:	61250513          	addi	a0,a0,1554 # 69e0 <statistics+0x94c>
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	87c50513          	addi	a0,a0,-1924 # 7c78 <statistics+0x1be4>
    ...
    4414:	7c050513          	addi	a0,a0,1984 # 6bd0 <statistics+0xb3c>
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	87250513          	addi	a0,a0,-1934 # 7cc0 <statistics+0x1c2c>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	84650513          	addi	a0,a0,-1978 # 7cc0 <statistics+0x1c2c>
  ...
  sleep(10); // one second
    ...
    44b6:	6ee50513          	addi	a0,a0,1774 # 6ba0 <statistics+0xb0c>
    ...
    44d0:	7f448493          	addi	s1,s1,2036 # 7cc0 <statistics+0x1c2c>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
    ...
    44f8:	7cc50513          	addi	a0,a0,1996 # 7cc0 <statistics+0x1c2c>
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	46650513          	addi	a0,a0,1126 # 69e0 <statistics+0x94c>
    ...
    45a4:	73050513          	addi	a0,a0,1840 # 7cd0 <statistics+0x1c3c>
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	5c050513          	addi	a0,a0,1472 # 6ba0 <statistics+0xb0c>
  ...
  if(pid2 == 0)
    ...
    4612:	3d250513          	addi	a0,a0,978 # 69e0 <statistics+0x94c>
  ...
  if(pid3 == 0){
    ...
    4656:	b7658593          	addi	a1,a1,-1162 # 61c8 <statistics+0x134>
    ...
    4680:	36450513          	addi	a0,a0,868 # 69e0 <statistics+0x94c>
    ...
    469c:	65850513          	addi	a0,a0,1624 # 7cf0 <statistics+0x1c5c>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	63450513          	addi	a0,a0,1588 # 7d08 <statistics+0x1c74>
  ...
  printf("kill... ");
    ...
    4704:	62050513          	addi	a0,a0,1568 # 7d20 <statistics+0x1c8c>
  ...
  printf("wait... ");
    ...
    4732:	60250513          	addi	a0,a0,1538 # 7d30 <statistics+0x1c9c>
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	23250513          	addi	a0,a0,562 # 69e0 <statistics+0x94c>
    ...
    47ce:	39e50513          	addi	a0,a0,926 # 6b68 <statistics+0xad4>
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	2a850513          	addi	a0,a0,680 # 6ae8 <statistics+0xa54>
    ...
    4878:	95458593          	addi	a1,a1,-1708 # 61c8 <statistics+0x134>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	40850513          	addi	a0,a0,1032 # 7d40 <statistics+0x1cac>
    ...
    4958:	08c50513          	addi	a0,a0,140 # 69e0 <statistics+0x94c>
    ...
    49a4:	3c050513          	addi	a0,a0,960 # 7d60 <statistics+0x1ccc>
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a48:	34c50513          	addi	a0,a0,844 # 7d90 <statistics+0x1cfc>
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	2c650513          	addi	a0,a0,710 # 7dc0 <statistics+0x1d2c>
    ...
    4b1a:	2d250513          	addi	a0,a0,722 # 7de8 <statistics+0x1d54>
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	25650513          	addi	a0,a0,598 # 7db0 <statistics+0x1d1c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	26e50513          	addi	a0,a0,622 # 7e08 <statistics+0x1d74>
  ...
  unlink("sharedfd");
    ...
    4bda:	1da50513          	addi	a0,a0,474 # 7db0 <statistics+0x1d1c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	23450513          	addi	a0,a0,564 # 7e30 <statistics+0x1d9c>
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c44:	20878793          	addi	a5,a5,520 # 7e48 <statistics+0x1db4>
    4c48:	f6f43823          	sd	a5,-144(s0)
    4c4c:	00003797          	auipc	a5,0x3
    4c50:	20478793          	addi	a5,a5,516 # 7e50 <statistics+0x1dbc>
    4c54:	f6f43c23          	sd	a5,-136(s0)
    4c58:	00003797          	auipc	a5,0x3
    4c5c:	20078793          	addi	a5,a5,512 # 7e58 <statistics+0x1dc4>
    4c60:	f8f43023          	sd	a5,-128(s0)
    4c64:	00003797          	auipc	a5,0x3
    4c68:	1fc78793          	addi	a5,a5,508 # 7e60 <statistics+0x1dcc>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cd6:	11650513          	addi	a0,a0,278 # 6de8 <statistics+0xd54>
    ...
    4d50:	11c50513          	addi	a0,a0,284 # 7e68 <statistics+0x1dd4>
    ...
    4d6a:	11250513          	addi	a0,a0,274 # 7e78 <statistics+0x1de4>
    ...
    4d90:	10450513          	addi	a0,a0,260 # 7e90 <statistics+0x1dfc>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e18:	08c50513          	addi	a0,a0,140 # 7ea0 <statistics+0x1e0c>
...
0000000000004e4c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e7a:	042b8b93          	addi	s7,s7,66 # 7eb8 <statistics+0x1e24>
  for(i = 0; i < N; i++){
    ...
    4ebc:	00850513          	addi	a0,a0,8 # 7ec0 <statistics+0x1e2c>
    ...
    4eda:	fe250513          	addi	a0,a0,-30 # 7eb8 <statistics+0x1e24>
  ...
  fd = open(".", 0);
    ...
    4f12:	93250513          	addi	a0,a0,-1742 # 6840 <statistics+0x7ac>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f8a:	f5a50513          	addi	a0,a0,-166 # 7ee0 <statistics+0x1e4c>
    ...
    4faa:	f5a50513          	addi	a0,a0,-166 # 7f00 <statistics+0x1e6c>
  ...
  for(i = 0; i < N; i++){
    ...
    4fe2:	f4a50513          	addi	a0,a0,-182 # 7f28 <statistics+0x1e94>
    ...
    4ffe:	9e650513          	addi	a0,a0,-1562 # 69e0 <statistics+0x94c>
...
00000000000051a8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5230:	d3450513          	addi	a0,a0,-716 # 7f60 <statistics+0x1ecc>
  ...
  for(i = 0; ; i++){
    ...
    5294:	ce050513          	addi	a0,a0,-800 # 7f70 <statistics+0x1edc>
    ...
    52b0:	ce450513          	addi	a0,a0,-796 # 7f90 <statistics+0x1efc>
    ...
    52cc:	ce850513          	addi	a0,a0,-792 # 7fb0 <statistics+0x1f1c>
    ...
    52e8:	cec50513          	addi	a0,a0,-788 # 7fd0 <statistics+0x1f3c>
    ...
    5304:	cf050513          	addi	a0,a0,-784 # 7ff0 <statistics+0x1f5c>
    ...
    5320:	cec50513          	addi	a0,a0,-788 # 8008 <statistics+0x1f74>
  ...
  unlink("bigfile.dat");
    ...
    534e:	c1650513          	addi	a0,a0,-1002 # 7f60 <statistics+0x1ecc>
    ...
    5372:	cba50513          	addi	a0,a0,-838 # 8028 <statistics+0x1f94>
...
0000000000005388 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53a8:	ca450513          	addi	a0,a0,-860 # 8048 <statistics+0x1fb4>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53c8:	c94c8c93          	addi	s9,s9,-876 # 8058 <statistics+0x1fc4>
    name[0] = 'f';
    ...
    5438:	c3450513          	addi	a0,a0,-972 # 8068 <statistics+0x1fd4>
  ...
  printf("fsfull test finished\n");
    ...
    54ae:	bde50513          	addi	a0,a0,-1058 # 8088 <statistics+0x1ff4>
    ...
    5504:	b7850513          	addi	a0,a0,-1160 # 8078 <statistics+0x1fe4>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5536:	b6e50513          	addi	a0,a0,-1170 # 80a0 <statistics+0x200c>
  ...
  if(pid == 0) {
    ...
    5566:	b6650513          	addi	a0,a0,-1178 # 80c8 <statistics+0x2034>
    ...
    558a:	b2a50513          	addi	a0,a0,-1238 # 80b0 <statistics+0x201c>
    ...
    55b2:	b2250513          	addi	a0,a0,-1246 # 80d0 <statistics+0x203c>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5602:	ada50513          	addi	a0,a0,-1318 # 80d8 <statistics+0x2044>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    565c:	b7098993          	addi	s3,s3,-1168 # 61c8 <statistics+0x134>
      uint64 a = (uint64) sbrk(4096);
    ...
    568e:	aa650513          	addi	a0,a0,-1370 # 8130 <statistics+0x209c>
    ...
    56a8:	a4c50513          	addi	a0,a0,-1460 # 80f0 <statistics+0x205c>
    ...
    56c2:	a5250513          	addi	a0,a0,-1454 # 8110 <statistics+0x207c>
  ...
  while(1){
    ...
    5710:	a4450513          	addi	a0,a0,-1468 # 8150 <statistics+0x20bc>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5772:	a02b8b93          	addi	s7,s7,-1534 # 8170 <statistics+0x20dc>
    int free0 = countfree();
    int free1 = 0;
    ...
    578c:	a00d0d13          	addi	s10,s10,-1536 # 8188 <statistics+0x20f4>
          return 1;
        }
      }
    }
    ...
    5794:	a18c8c93          	addi	s9,s9,-1512 # 81a8 <statistics+0x2114>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    586c:	97058593          	addi	a1,a1,-1680 # 81d8 <statistics+0x2144>
  ...
  char *justone = 0;
    ...
    588a:	95a58593          	addi	a1,a1,-1702 # 81e0 <statistics+0x214c>
    ...
    58a0:	99458593          	addi	a1,a1,-1644 # 8230 <statistics+0x219c>
  ...
  int continuous = 0;
    ...
    58cc:	92050513          	addi	a0,a0,-1760 # 81e8 <statistics+0x2154>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    58f2:	92a50513          	addi	a0,a0,-1750 # 8218 <statistics+0x2184>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5c76:	98650513          	addi	a0,a0,-1658 # 85f8 <digits>
    5c7a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    5d76:	00003717          	auipc	a4,0x3
    5d7a:	82a70713          	addi	a4,a4,-2006 # 85a0 <statistics+0x250c>
  ...
  putc(fd, 'x');
    ...
    5e04:	7f8b8b93          	addi	s7,s7,2040 # 85f8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5e58:	74490913          	addi	s2,s2,1860 # 8598 <statistics+0x2504>
        while(*s != 0){
...
{
    6094:	7179                	addi	sp,sp,-48
    6096:	f406                	sd	ra,40(sp)
    6098:	f022                	sd	s0,32(sp)
    609a:	ec26                	sd	s1,24(sp)
    609c:	e84a                	sd	s2,16(sp)
    609e:	e44e                	sd	s3,8(sp)
    60a0:	e052                	sd	s4,0(sp)
  ...
  fd = open("statistics", O_RDONLY);
    60a8:	4581                	li	a1,0
    60aa:	00002517          	auipc	a0,0x2
    60ae:	56650513          	addi	a0,a0,1382 # 8610 <digits+0x18>
    60b2:	00000097          	auipc	ra,0x0
    60b6:	b1c080e7          	jalr	-1252(ra) # 5bce <open>
  if(fd < 0) {
    60ba:	04054263          	bltz	a0,60fe <statistics+0x6a>
    60be:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    60c0:	4481                	li	s1,0
    60c2:	03205063          	blez	s2,60e2 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    60c6:	4099063b          	subw	a2,s2,s1
    60ca:	009a05b3          	add	a1,s4,s1
    60ce:	854e                	mv	a0,s3
    60d0:	00000097          	auipc	ra,0x0
    60d4:	ad6080e7          	jalr	-1322(ra) # 5ba6 <read>
    60d8:	00054563          	bltz	a0,60e2 <statistics+0x4e>
      break;
    }
    i += n;
    60dc:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    60de:	ff24c4e3          	blt	s1,s2,60c6 <statistics+0x32>
  }
  close(fd);
    60e2:	854e                	mv	a0,s3
    60e4:	00000097          	auipc	ra,0x0
    60e8:	ad2080e7          	jalr	-1326(ra) # 5bb6 <close>
  return i;
}
    60ec:	8526                	mv	a0,s1
    60ee:	70a2                	ld	ra,40(sp)
    60f0:	7402                	ld	s0,32(sp)
    60f2:	64e2                	ld	s1,24(sp)
    60f4:	6942                	ld	s2,16(sp)
    60f6:	69a2                	ld	s3,8(sp)
    60f8:	6a02                	ld	s4,0(sp)
    60fa:	6145                	addi	sp,sp,48
    60fc:	8082                	ret
      fprintf(2, "stats: open failed\n");
    60fe:	00002597          	auipc	a1,0x2
    6102:	52258593          	addi	a1,a1,1314 # 8620 <digits+0x28>
    6106:	4509                	li	a0,2
    6108:	00000097          	auipc	ra,0x0
    610c:	dc0080e7          	jalr	-576(ra) # 5ec8 <fprintf>
      exit(1);
    6110:	4505                	li	a0,1
    6112:	00000097          	auipc	ra,0x0
    6116:	a7c080e7          	jalr	-1412(ra) # 5b8e <exit>
