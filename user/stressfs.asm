...
main(int argc, char *argv[])
{
  ...
  1a:	93a78793          	addi	a5,a5,-1734 # 950 <statistics+0xb8>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8f450513          	addi	a0,a0,-1804 # 920 <statistics+0x88>
  ...
  6c:	8d050513          	addi	a0,a0,-1840 # 938 <statistics+0xa0>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	89250513          	addi	a0,a0,-1902 # 948 <statistics+0xb0>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47a:	54a50513          	addi	a0,a0,1354 # 9c0 <digits>
 47e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 57e:	3ee70713          	addi	a4,a4,1006 # 968 <statistics+0xd0>
 ...
 65c:	30890913          	addi	s2,s2,776 # 960 <statistics+0xc8>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 8b2:	12a50513          	addi	a0,a0,298 # 9d8 <digits+0x18>
 ...
 906:	0e658593          	addi	a1,a1,230 # 9e8 <digits+0x28>
 90a:	4509                	li	a0,2
