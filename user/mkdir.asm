...
main(int argc, char *argv[])
{
  ...
  40:	85458593          	addi	a1,a1,-1964 # 890 <statistics+0x8e>
  44:	4509                	li	a0,2
  ...
  5e:	84e58593          	addi	a1,a1,-1970 # 8a8 <statistics+0xa6>
  62:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e8:	3ec70713          	addi	a4,a4,1004 # 8d0 <statistics+0xce>
 ...
 5c6:	30690913          	addi	s2,s2,774 # 8c8 <statistics+0xc6>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 81c:	12850513          	addi	a0,a0,296 # 940 <digits+0x18>
 820:	00000097          	auipc	ra,0x0
 824:	b1c080e7          	jalr	-1252(ra) # 33c <open>
  if(fd < 0) {
 ...
 842:	ad6080e7          	jalr	-1322(ra) # 314 <read>
 ...
 856:	ad2080e7          	jalr	-1326(ra) # 324 <close>
  return i;
}
 85a:	8526                	mv	a0,s1
 ...
 870:	0e458593          	addi	a1,a1,228 # 950 <digits+0x28>
 874:	4509                	li	a0,2
 ...
 884:	a7c080e7          	jalr	-1412(ra) # 2fc <exit>
