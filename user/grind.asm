...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	32650513          	addi	a0,a0,806 # 13c0 <statistics+0x8c>
      a2:	00001097          	auipc	ra,0x1
      a6:	df4080e7          	jalr	-524(ra) # e96 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	31650513          	addi	a0,a0,790 # 13c0 <statistics+0x8c>
      b2:	00001097          	auipc	ra,0x1
      b6:	dec080e7          	jalr	-532(ra) # e9e <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	30c50513          	addi	a0,a0,780 # 13c8 <statistics+0x94>
  ...
  chdir("/");
      ...
      da:	31250513          	addi	a0,a0,786 # 13e8 <statistics+0xb4>
      de:	00001097          	auipc	ra,0x1
      e2:	dc0080e7          	jalr	-576(ra) # e9e <chdir>
      e6:	00001997          	auipc	s3,0x1
      ea:	31298993          	addi	s3,s3,786 # 13f8 <statistics+0xc4>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	30098993          	addi	s3,s3,768 # 13f0 <statistics+0xbc>
  uint64 iters = 0;
      f8:	4481                	li	s1,0
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	5ac90913          	addi	s2,s2,1452 # 16a8 <statistics+0x374>
    ...
    if(what == 1){
     ...
     10e:	2f650513          	addi	a0,a0,758 # 1400 <statistics+0xcc>
    ...
    if(what == 1){
     ...
     168:	2ac50513          	addi	a0,a0,684 # 1410 <statistics+0xdc>
     ...
     182:	28250513          	addi	a0,a0,642 # 1400 <statistics+0xcc>
     ...
     194:	23050513          	addi	a0,a0,560 # 13c0 <statistics+0x8c>
     ...
     1a6:	28650513          	addi	a0,a0,646 # 1428 <statistics+0xf4>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	cd4080e7          	jalr	-812(ra) # e7e <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	23650513          	addi	a0,a0,566 # 13e8 <statistics+0xb4>
     1ba:	00001097          	auipc	ra,0x1
     1be:	ce4080e7          	jalr	-796(ra) # e9e <chdir>
     1c2:	b785                	j	122 <go+0xaa>
        printf("grind: chdir grindir failed\n");
     1c4:	00001517          	auipc	a0,0x1
     1c8:	20450513          	addi	a0,a0,516 # 13c8 <statistics+0x94>
     ...
     1f0:	24450513          	addi	a0,a0,580 # 1430 <statistics+0xfc>
     ...
     212:	23250513          	addi	a0,a0,562 # 1440 <statistics+0x10c>
     ...
     256:	1ae50513          	addi	a0,a0,430 # 1400 <statistics+0xcc>
     25a:	00001097          	auipc	ra,0x1
     25e:	c3c080e7          	jalr	-964(ra) # e96 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	1f250513          	addi	a0,a0,498 # 1458 <statistics+0x124>
     ...
     282:	1ea50513          	addi	a0,a0,490 # 1468 <statistics+0x134>
     ...
     294:	1e050513          	addi	a0,a0,480 # 1470 <statistics+0x13c>
     298:	00001097          	auipc	ra,0x1
     29c:	bfe080e7          	jalr	-1026(ra) # e96 <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	1d450513          	addi	a0,a0,468 # 1478 <statistics+0x144>
     ...
     2c0:	1cc50513          	addi	a0,a0,460 # 1488 <statistics+0x154>
     ...
     2d2:	18250513          	addi	a0,a0,386 # 1450 <statistics+0x11c>
     2d6:	00001097          	auipc	ra,0x1
     2da:	ba8080e7          	jalr	-1112(ra) # e7e <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	14a58593          	addi	a1,a1,330 # 1428 <statistics+0xf4>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	1aa50513          	addi	a0,a0,426 # 1490 <statistics+0x15c>
     ...
     2fc:	1b050513          	addi	a0,a0,432 # 14a8 <statistics+0x174>
     300:	00001097          	auipc	ra,0x1
     304:	b7e080e7          	jalr	-1154(ra) # e7e <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	12858593          	addi	a1,a1,296 # 1430 <statistics+0xfc>
     310:	00001517          	auipc	a0,0x1
     314:	1a850513          	addi	a0,a0,424 # 14b8 <statistics+0x184>
     ...
     348:	17c50513          	addi	a0,a0,380 # 14c0 <statistics+0x18c>
     ...
     396:	12e50513          	addi	a0,a0,302 # 14c0 <statistics+0x18c>
     ...
     3f6:	0e650513          	addi	a0,a0,230 # 14d8 <statistics+0x1a4>
     ...
     422:	08250513          	addi	a0,a0,130 # 14a0 <statistics+0x16c>
     ...
     444:	08050513          	addi	a0,a0,128 # 14c0 <statistics+0x18c>
     ...
     45e:	08e50513          	addi	a0,a0,142 # 14e8 <statistics+0x1b4>
     ...
     4ac:	01850513          	addi	a0,a0,24 # 14c0 <statistics+0x18c>
     ...
     508:	ffc50513          	addi	a0,a0,-4 # 1500 <statistics+0x1cc>
     ...
     534:	fe858593          	addi	a1,a1,-24 # 1518 <statistics+0x1e4>
     ...
     636:	e8e50513          	addi	a0,a0,-370 # 14c0 <statistics+0x18c>
     ...
     650:	f1450513          	addi	a0,a0,-236 # 1560 <statistics+0x22c>
     ...
     664:	f0050513          	addi	a0,a0,-256 # 1560 <statistics+0x22c>
     ...
     67c:	ea058593          	addi	a1,a1,-352 # 1518 <statistics+0x1e4>
     ...
     6c2:	ea250513          	addi	a0,a0,-350 # 1560 <statistics+0x22c>
     6c6:	00000097          	auipc	ra,0x0
     6ca:	7b8080e7          	jalr	1976(ra) # e7e <unlink>
     6ce:	bc91                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     6d0:	00001517          	auipc	a0,0x1
     6d4:	e9850513          	addi	a0,a0,-360 # 1568 <statistics+0x234>
     ...
     6ee:	e9650513          	addi	a0,a0,-362 # 1580 <statistics+0x24c>
     ...
     708:	e9450513          	addi	a0,a0,-364 # 1598 <statistics+0x264>
     ...
     724:	e9050513          	addi	a0,a0,-368 # 15b0 <statistics+0x27c>
     ...
     73e:	e9e50513          	addi	a0,a0,-354 # 15d8 <statistics+0x2a4>
     ...
     826:	e5658593          	addi	a1,a1,-426 # 1678 <statistics+0x344>
     ...
     84a:	e3a50513          	addi	a0,a0,-454 # 1680 <statistics+0x34c>
     ...
     864:	ca058593          	addi	a1,a1,-864 # 1500 <statistics+0x1cc>
     868:	4509                	li	a0,2
     ...
     880:	c8458593          	addi	a1,a1,-892 # 1500 <statistics+0x1cc>
     884:	4509                	li	a0,2
     ...
     8dc:	d2858593          	addi	a1,a1,-728 # 1600 <statistics+0x2cc>
     8e0:	4509                	li	a0,2
     ...
     950:	b7458593          	addi	a1,a1,-1164 # 14c0 <statistics+0x18c>
     954:	4509                	li	a0,2
     ...
     99c:	c6858593          	addi	a1,a1,-920 # 1600 <statistics+0x2cc>
     9a0:	4509                	li	a0,2
     ...
     9e0:	c2458593          	addi	a1,a1,-988 # 1600 <statistics+0x2cc>
     9e4:	4509                	li	a0,2
     ...
     a48:	a7c58593          	addi	a1,a1,-1412 # 14c0 <statistics+0x18c>
     a4c:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	a3450513          	addi	a0,a0,-1484 # 14a0 <statistics+0x16c>
     a74:	00000097          	auipc	ra,0x0
     a78:	40a080e7          	jalr	1034(ra) # e7e <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	9d450513          	addi	a0,a0,-1580 # 1450 <statistics+0x11c>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aba:	a0a50513          	addi	a0,a0,-1526 # 14c0 <statistics+0x18c>
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b02:	9c250513          	addi	a0,a0,-1598 # 14c0 <statistics+0x18c>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f16:	85650513          	addi	a0,a0,-1962 # 1768 <digits>
     f1a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    101a:	6fa70713          	addi	a4,a4,1786 # 1710 <statistics+0x3dc>
  ...
  putc(fd, 'x');
    ...
    10a4:	6c8b8b93          	addi	s7,s7,1736 # 1768 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10f8:	61490913          	addi	s2,s2,1556 # 1708 <statistics+0x3d4>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
  ...
  fd = open("statistics", O_RDONLY);
    ...
    134e:	43650513          	addi	a0,a0,1078 # 1780 <digits+0x18>
    1352:	00000097          	auipc	ra,0x0
    1356:	b1c080e7          	jalr	-1252(ra) # e6e <open>
  if(fd < 0) {
    135a:	04054263          	bltz	a0,139e <statistics+0x6a>
    135e:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    1360:	4481                	li	s1,0
    1362:	03205063          	blez	s2,1382 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    1366:	4099063b          	subw	a2,s2,s1
    136a:	009a05b3          	add	a1,s4,s1
    136e:	854e                	mv	a0,s3
    1370:	00000097          	auipc	ra,0x0
    1374:	ad6080e7          	jalr	-1322(ra) # e46 <read>
    1378:	00054563          	bltz	a0,1382 <statistics+0x4e>
      break;
    }
    i += n;
    137c:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    137e:	ff24c4e3          	blt	s1,s2,1366 <statistics+0x32>
  }
  close(fd);
    1382:	854e                	mv	a0,s3
    1384:	00000097          	auipc	ra,0x0
    1388:	ad2080e7          	jalr	-1326(ra) # e56 <close>
  return i;
}
    138c:	8526                	mv	a0,s1
    138e:	70a2                	ld	ra,40(sp)
    1390:	7402                	ld	s0,32(sp)
    1392:	64e2                	ld	s1,24(sp)
    1394:	6942                	ld	s2,16(sp)
    1396:	69a2                	ld	s3,8(sp)
    1398:	6a02                	ld	s4,0(sp)
    139a:	6145                	addi	sp,sp,48
    139c:	8082                	ret
      fprintf(2, "stats: open failed\n");
    139e:	00000597          	auipc	a1,0x0
    13a2:	3f258593          	addi	a1,a1,1010 # 1790 <digits+0x28>
    13a6:	4509                	li	a0,2
    13a8:	00000097          	auipc	ra,0x0
    13ac:	dc0080e7          	jalr	-576(ra) # 1168 <fprintf>
      exit(1);
    13b0:	4505                	li	a0,1
    13b2:	00000097          	auipc	ra,0x0
    13b6:	a7c080e7          	jalr	-1412(ra) # e2e <exit>
