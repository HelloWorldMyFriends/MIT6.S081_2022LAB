...
main(void)
{
  ...
  12:	91250513          	addi	a0,a0,-1774 # 920 <statistics+0x88>
  ...
  3a:	90290913          	addi	s2,s2,-1790 # 938 <statistics+0xa0>
  3e:	854a                	mv	a0,s2
  40:	00000097          	auipc	ra,0x0
  44:	6ba080e7          	jalr	1722(ra) # 6fa <printf>
    pid = fork();
  ...
  6e:	91e50513          	addi	a0,a0,-1762 # 988 <statistics+0xf0>
  72:	00000097          	auipc	ra,0x0
  76:	688080e7          	jalr	1672(ra) # 6fa <printf>
        exit(1);
  7a:	4505                	li	a0,1
  ...
  8c:	89850513          	addi	a0,a0,-1896 # 920 <statistics+0x88>
  ...
  a0:	88c50513          	addi	a0,a0,-1908 # 928 <statistics+0x90>
  a4:	00000097          	auipc	ra,0x0
  a8:	336080e7          	jalr	822(ra) # 3da <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00001517          	auipc	a0,0x1
  b2:	87250513          	addi	a0,a0,-1934 # 920 <statistics+0x88>
  b6:	00000097          	auipc	ra,0x0
  ba:	31c080e7          	jalr	796(ra) # 3d2 <open>
  be:	b795                	j	22 <main+0x22>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	89050513          	addi	a0,a0,-1904 # 950 <statistics+0xb8>
  c8:	00000097          	auipc	ra,0x0
  cc:	632080e7          	jalr	1586(ra) # 6fa <printf>
      exit(1);
  d0:	4505                	li	a0,1
  ...
  e6:	88650513          	addi	a0,a0,-1914 # 968 <statistics+0xd0>
  ea:	00000097          	auipc	ra,0x0
  ee:	2e0080e7          	jalr	736(ra) # 3ca <exec>
      printf("init: exec sh failed\n");
  f2:	00001517          	auipc	a0,0x1
  f6:	87e50513          	addi	a0,a0,-1922 # 970 <statistics+0xd8>
  fa:	00000097          	auipc	ra,0x0
  fe:	600080e7          	jalr	1536(ra) # 6fa <printf>
      exit(1);
 102:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47a:	59250513          	addi	a0,a0,1426 # a08 <digits>
 47e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 57e:	43670713          	addi	a4,a4,1078 # 9b0 <statistics+0x118>
 ...
 608:	404b8b93          	addi	s7,s7,1028 # a08 <digits>
 ...
 65c:	35090913          	addi	s2,s2,848 # 9a8 <statistics+0x110>
        while(*s != 0){
...
free(void *ap)
{
 ...
 73e:	8d67b783          	ld	a5,-1834(a5) # 1010 <freep>
 ...
 766:	00e6ea63          	bltu	a3,a4,77a <free+0x4a>
{
 ...
 7a8:	86f73623          	sd	a5,-1940(a4) # 1010 <freep>
}
 7ac:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7da:	83a53503          	ld	a0,-1990(a0) # 1010 <freep>
 ...
 802:	81290913          	addi	s2,s2,-2030 # 1010 <freep>
  if(p == (char*)-1)
 806:	5afd                	li	s5,-1
 808:	a895                	j	87c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 80a:	00001797          	auipc	a5,0x1
 80e:	81678793          	addi	a5,a5,-2026 # 1020 <base>
 ...
 83e:	7ca73b23          	sd	a0,2006(a4) # 1010 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8b2:	07a50513          	addi	a0,a0,122 # 928 <statistics+0x90>
 8b6:	00000097          	auipc	ra,0x0
 8ba:	b1c080e7          	jalr	-1252(ra) # 3d2 <open>
  if(fd < 0) {
 8be:	04054263          	bltz	a0,902 <statistics+0x6a>
 8c2:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 8c4:	4481                	li	s1,0
 8c6:	03205063          	blez	s2,8e6 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 8ca:	4099063b          	subw	a2,s2,s1
 8ce:	009a05b3          	add	a1,s4,s1
 8d2:	854e                	mv	a0,s3
 8d4:	00000097          	auipc	ra,0x0
 8d8:	ad6080e7          	jalr	-1322(ra) # 3aa <read>
 8dc:	00054563          	bltz	a0,8e6 <statistics+0x4e>
      break;
    }
    i += n;
 8e0:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 8e2:	ff24c4e3          	blt	s1,s2,8ca <statistics+0x32>
  }
  close(fd);
 8e6:	854e                	mv	a0,s3
 8e8:	00000097          	auipc	ra,0x0
 8ec:	ad2080e7          	jalr	-1326(ra) # 3ba <close>
  return i;
}
 8f0:	8526                	mv	a0,s1
 ...
 906:	11e58593          	addi	a1,a1,286 # a20 <digits+0x18>
 90a:	4509                	li	a0,2
 90c:	00000097          	auipc	ra,0x0
 910:	dc0080e7          	jalr	-576(ra) # 6cc <fprintf>
      exit(1);
 914:	4505                	li	a0,1
 916:	00000097          	auipc	ra,0x0
 91a:	a7c080e7          	jalr	-1412(ra) # 392 <exit>
