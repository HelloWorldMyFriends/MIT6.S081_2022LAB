...
main(int argc, char *argv[])
{
  ...
  14:	81058593          	addi	a1,a1,-2032 # 820 <malloc+0xf4>
  18:	4509                	li	a0,2
  ...
  50:	7ec58593          	addi	a1,a1,2028 # 838 <malloc+0x10c>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f4:	4c050513          	addi	a0,a0,1216 # 8b0 <digits>
 3f8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f8:	36470713          	addi	a4,a4,868 # 858 <malloc+0x12c>
 ...
 5d6:	27e90913          	addi	s2,s2,638 # 850 <malloc+0x124>
        while(*s != 0){
