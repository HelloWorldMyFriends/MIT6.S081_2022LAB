...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c4:	33070713          	addi	a4,a4,816 # 7f0 <malloc+0xf8>
 ...
 54e:	2feb8b93          	addi	s7,s7,766 # 848 <digits>
 ...
 5a2:	24a90913          	addi	s2,s2,586 # 7e8 <malloc+0xf0>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7d2:	b82080e7          	jalr	-1150(ra) # 350 <sbrk>
  if(p == (char*)-1)
