...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49c:	3b070713          	addi	a4,a4,944 # 848 <statistics+0x92>
 ...
 526:	37eb8b93          	addi	s7,s7,894 # 8a0 <digits>
 ...
 57a:	2ca90913          	addi	s2,s2,714 # 840 <statistics+0x8a>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 7d0:	0ec50513          	addi	a0,a0,236 # 8b8 <digits+0x18>
 7d4:	00000097          	auipc	ra,0x0
 7d8:	b1c080e7          	jalr	-1252(ra) # 2f0 <open>
  if(fd < 0) {
 7dc:	04054263          	bltz	a0,820 <statistics+0x6a>
 7e0:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 7e2:	4481                	li	s1,0
 7e4:	03205063          	blez	s2,804 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 7e8:	4099063b          	subw	a2,s2,s1
 7ec:	009a05b3          	add	a1,s4,s1
 7f0:	854e                	mv	a0,s3
 7f2:	00000097          	auipc	ra,0x0
 7f6:	ad6080e7          	jalr	-1322(ra) # 2c8 <read>
 7fa:	00054563          	bltz	a0,804 <statistics+0x4e>
      break;
    }
    i += n;
 7fe:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 800:	ff24c4e3          	blt	s1,s2,7e8 <statistics+0x32>
  }
  close(fd);
 804:	854e                	mv	a0,s3
 806:	00000097          	auipc	ra,0x0
 80a:	ad2080e7          	jalr	-1326(ra) # 2d8 <close>
  return i;
}
 80e:	8526                	mv	a0,s1
 810:	70a2                	ld	ra,40(sp)
 812:	7402                	ld	s0,32(sp)
 814:	64e2                	ld	s1,24(sp)
 816:	6942                	ld	s2,16(sp)
 818:	69a2                	ld	s3,8(sp)
 81a:	6a02                	ld	s4,0(sp)
 81c:	6145                	addi	sp,sp,48
 81e:	8082                	ret
      fprintf(2, "stats: open failed\n");
 820:	00000597          	auipc	a1,0x0
 824:	0a858593          	addi	a1,a1,168 # 8c8 <digits+0x28>
 828:	4509                	li	a0,2
 82a:	00000097          	auipc	ra,0x0
 82e:	dc0080e7          	jalr	-576(ra) # 5ea <fprintf>
      exit(1);
 832:	4505                	li	a0,1
 834:	00000097          	auipc	ra,0x0
 838:	a7c080e7          	jalr	-1412(ra) # 2b0 <exit>
