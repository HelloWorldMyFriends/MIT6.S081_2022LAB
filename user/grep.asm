...
00000000000001ec <main>:
{
 ...
 25e:	86658593          	addi	a1,a1,-1946 # ac0 <statistics+0x8a>
 262:	4509                	li	a0,2
 ...
 294:	85050513          	addi	a0,a0,-1968 # ae0 <statistics+0xaa>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 618:	54450513          	addi	a0,a0,1348 # b58 <digits>
 61c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 71c:	3e870713          	addi	a4,a4,1000 # b00 <statistics+0xca>
 ...
 7a6:	3b6b8b93          	addi	s7,s7,950 # b58 <digits>
 ...
 7fa:	30290913          	addi	s2,s2,770 # af8 <statistics+0xc2>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 a50:	12450513          	addi	a0,a0,292 # b70 <digits+0x18>
 a54:	00000097          	auipc	ra,0x0
 a58:	b1c080e7          	jalr	-1252(ra) # 570 <open>
  if(fd < 0) {
 a5c:	04054263          	bltz	a0,aa0 <statistics+0x6a>
 a60:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 a62:	4481                	li	s1,0
 a64:	03205063          	blez	s2,a84 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 a68:	4099063b          	subw	a2,s2,s1
 a6c:	009a05b3          	add	a1,s4,s1
 a70:	854e                	mv	a0,s3
 a72:	00000097          	auipc	ra,0x0
 a76:	ad6080e7          	jalr	-1322(ra) # 548 <read>
 a7a:	00054563          	bltz	a0,a84 <statistics+0x4e>
      break;
    }
    i += n;
 a7e:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 a80:	ff24c4e3          	blt	s1,s2,a68 <statistics+0x32>
  }
  close(fd);
 a84:	854e                	mv	a0,s3
 a86:	00000097          	auipc	ra,0x0
 a8a:	ad2080e7          	jalr	-1326(ra) # 558 <close>
  return i;
}
 a8e:	8526                	mv	a0,s1
 ...
 a9e:	8082                	ret
      fprintf(2, "stats: open failed\n");
 aa0:	00000597          	auipc	a1,0x0
 aa4:	0e058593          	addi	a1,a1,224 # b80 <digits+0x28>
 aa8:	4509                	li	a0,2
 aaa:	00000097          	auipc	ra,0x0
 aae:	dc0080e7          	jalr	-576(ra) # 86a <fprintf>
      exit(1);
 ab2:	4505                	li	a0,1
 ab4:	00000097          	auipc	ra,0x0
 ab8:	a7c080e7          	jalr	-1412(ra) # 530 <exit>
