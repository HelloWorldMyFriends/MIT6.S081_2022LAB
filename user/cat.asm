...
cat(int fd)
{
  ...
  44:	8f058593          	addi	a1,a1,-1808 # 930 <statistics+0x88>
  48:	4509                	li	a0,2
  ...
  72:	8da58593          	addi	a1,a1,-1830 # 948 <statistics+0xa0>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 104:	86058593          	addi	a1,a1,-1952 # 960 <statistics+0xb8>
 108:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48a:	55250513          	addi	a0,a0,1362 # 9d8 <digits>
 48e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 58e:	3f670713          	addi	a4,a4,1014 # 980 <statistics+0xd8>
 ...
 618:	3c4b8b93          	addi	s7,s7,964 # 9d8 <digits>
 ...
 66c:	31090913          	addi	s2,s2,784 # 978 <statistics+0xd0>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 8c2:	13250513          	addi	a0,a0,306 # 9f0 <digits+0x18>
 8c6:	00000097          	auipc	ra,0x0
 8ca:	b1c080e7          	jalr	-1252(ra) # 3e2 <open>
  if(fd < 0) {
 8ce:	04054263          	bltz	a0,912 <statistics+0x6a>
 8d2:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 8d4:	4481                	li	s1,0
 8d6:	03205063          	blez	s2,8f6 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 8da:	4099063b          	subw	a2,s2,s1
 8de:	009a05b3          	add	a1,s4,s1
 8e2:	854e                	mv	a0,s3
 8e4:	00000097          	auipc	ra,0x0
 8e8:	ad6080e7          	jalr	-1322(ra) # 3ba <read>
 8ec:	00054563          	bltz	a0,8f6 <statistics+0x4e>
      break;
    }
    i += n;
 8f0:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 8f2:	ff24c4e3          	blt	s1,s2,8da <statistics+0x32>
  }
  close(fd);
 8f6:	854e                	mv	a0,s3
 8f8:	00000097          	auipc	ra,0x0
 8fc:	ad2080e7          	jalr	-1326(ra) # 3ca <close>
  return i;
}
 900:	8526                	mv	a0,s1
 ...
 916:	0ee58593          	addi	a1,a1,238 # a00 <digits+0x28>
 91a:	4509                	li	a0,2
 91c:	00000097          	auipc	ra,0x0
 920:	dc0080e7          	jalr	-576(ra) # 6dc <fprintf>
      exit(1);
 924:	4505                	li	a0,1
 926:	00000097          	auipc	ra,0x0
 92a:	a7c080e7          	jalr	-1412(ra) # 3a2 <exit>
