...
main(int argc, char *argv[])
{
  ...
  34:	870a8a93          	addi	s5,s5,-1936 # 8a0 <statistics+0x86>
  ...
  76:	83658593          	addi	a1,a1,-1994 # 8a8 <statistics+0x8e>
  7a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fc:	51850513          	addi	a0,a0,1304 # 910 <digits>
 400:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 500:	3bc70713          	addi	a4,a4,956 # 8b8 <statistics+0x9e>
 ...
 58a:	38ab8b93          	addi	s7,s7,906 # 910 <digits>
 ...
 5de:	2d690913          	addi	s2,s2,726 # 8b0 <statistics+0x96>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 834:	0f850513          	addi	a0,a0,248 # 928 <digits+0x18>
 838:	00000097          	auipc	ra,0x0
 83c:	b1c080e7          	jalr	-1252(ra) # 354 <open>
  if(fd < 0) {
 ...
 85a:	ad6080e7          	jalr	-1322(ra) # 32c <read>
 ...
 86e:	ad2080e7          	jalr	-1326(ra) # 33c <close>
  return i;
}
 872:	8526                	mv	a0,s1
 ...
 888:	0b458593          	addi	a1,a1,180 # 938 <digits+0x28>
 88c:	4509                	li	a0,2
 88e:	00000097          	auipc	ra,0x0
 892:	dc0080e7          	jalr	-576(ra) # 64e <fprintf>
      exit(1);
 896:	4505                	li	a0,1
 898:	00000097          	auipc	ra,0x0
 89c:	a7c080e7          	jalr	-1412(ra) # 314 <exit>
