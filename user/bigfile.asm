...
main()
{
  ...
  28:	8fc50513          	addi	a0,a0,-1796 # 920 <malloc+0xec>
  ...
  44:	920a0a13          	addi	s4,s4,-1760 # 960 <malloc+0x12c>
    *(int*)buf = blocks;
  ...
  76:	70a080e7          	jalr	1802(ra) # 77c <printf>
  7a:	b7f9                	j	48 <main+0x48>
    printf("bigfile: cannot open big.file for writing\n");
  7c:	00001517          	auipc	a0,0x1
  80:	8b450513          	addi	a0,a0,-1868 # 930 <malloc+0xfc>
  ...
  9c:	8d050513          	addi	a0,a0,-1840 # 968 <malloc+0x134>
  a0:	00000097          	auipc	ra,0x0
  a4:	6dc080e7          	jalr	1756(ra) # 77c <printf>
  if(blocks != 65803) {
  a8:	67c1                	lui	a5,0x10
  ...
  b6:	8ce50513          	addi	a0,a0,-1842 # 980 <malloc+0x14c>
  ba:	00000097          	auipc	ra,0x0
  be:	6c2080e7          	jalr	1730(ra) # 77c <printf>
    exit(-1);
  c2:	557d                	li	a0,-1
  ...
  dc:	84850513          	addi	a0,a0,-1976 # 920 <malloc+0xec>
 ...
 11e:	90e50513          	addi	a0,a0,-1778 # a28 <malloc+0x1f4>
 122:	00000097          	auipc	ra,0x0
 126:	65a080e7          	jalr	1626(ra) # 77c <printf>
 ...
 138:	86c50513          	addi	a0,a0,-1940 # 9a0 <malloc+0x16c>
 13c:	00000097          	auipc	ra,0x0
 140:	640080e7          	jalr	1600(ra) # 77c <printf>
    exit(-1);
 144:	557d                	li	a0,-1
 ...
 154:	88050513          	addi	a0,a0,-1920 # 9d0 <malloc+0x19c>
 158:	00000097          	auipc	ra,0x0
 15c:	624080e7          	jalr	1572(ra) # 77c <printf>
      exit(-1);
 160:	557d                	li	a0,-1
 ...
 170:	88c50513          	addi	a0,a0,-1908 # 9f8 <malloc+0x1c4>
 174:	00000097          	auipc	ra,0x0
 178:	608080e7          	jalr	1544(ra) # 77c <printf>
      exit(-1);
 17c:	557d                	li	a0,-1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 600:	44c70713          	addi	a4,a4,1100 # a48 <malloc+0x214>
 ...
 68a:	41ab8b93          	addi	s7,s7,1050 # aa0 <digits>
 ...
 6de:	36690913          	addi	s2,s2,870 # a40 <malloc+0x20c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 90e:	b8a080e7          	jalr	-1142(ra) # 494 <sbrk>
  if(p == (char*)-1)
