...
00000000000001ec <main>:
{
 ...
 25e:	7f658593          	addi	a1,a1,2038 # a50 <malloc+0xf0>
 262:	4509                	li	a0,2
 ...
 294:	7e050513          	addi	a0,a0,2016 # a70 <malloc+0x110>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 628:	4c450513          	addi	a0,a0,1220 # ae8 <digits>
 62c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 72c:	36870713          	addi	a4,a4,872 # a90 <malloc+0x130>
 ...
 7b6:	336b8b93          	addi	s7,s7,822 # ae8 <digits>
 ...
 80a:	28290913          	addi	s2,s2,642 # a88 <malloc+0x128>
        while(*s != 0){
