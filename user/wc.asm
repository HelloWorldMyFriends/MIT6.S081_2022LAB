...
wc(int fd, char *name)
{
  ...
  3c:	968a0a13          	addi	s4,s4,-1688 # 9a0 <statistics+0x8a>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  aa:	91250513          	addi	a0,a0,-1774 # 9b8 <statistics+0xa2>
  ...
  d8:	8d450513          	addi	a0,a0,-1836 # 9a8 <statistics+0x92>
...
main(int argc, char *argv[])
{
 ...
 154:	87858593          	addi	a1,a1,-1928 # 9c8 <statistics+0xb2>
 158:	4501                	li	a0,0
 ...
 174:	86050513          	addi	a0,a0,-1952 # 9d0 <statistics+0xba>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4f8:	55450513          	addi	a0,a0,1364 # a48 <digits>
 4fc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5fc:	3f870713          	addi	a4,a4,1016 # 9f0 <statistics+0xda>
 ...
 686:	3c6b8b93          	addi	s7,s7,966 # a48 <digits>
 ...
 6da:	31290913          	addi	s2,s2,786 # 9e8 <statistics+0xd2>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 930:	13450513          	addi	a0,a0,308 # a60 <digits+0x18>
 934:	00000097          	auipc	ra,0x0
 938:	b1c080e7          	jalr	-1252(ra) # 450 <open>
  if(fd < 0) {
 93c:	04054263          	bltz	a0,980 <statistics+0x6a>
 940:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 942:	4481                	li	s1,0
 944:	03205063          	blez	s2,964 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 948:	4099063b          	subw	a2,s2,s1
 94c:	009a05b3          	add	a1,s4,s1
 950:	854e                	mv	a0,s3
 952:	00000097          	auipc	ra,0x0
 956:	ad6080e7          	jalr	-1322(ra) # 428 <read>
 95a:	00054563          	bltz	a0,964 <statistics+0x4e>
      break;
    }
    i += n;
 95e:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 960:	ff24c4e3          	blt	s1,s2,948 <statistics+0x32>
  }
  close(fd);
 964:	854e                	mv	a0,s3
 966:	00000097          	auipc	ra,0x0
 96a:	ad2080e7          	jalr	-1326(ra) # 438 <close>
  return i;
}
 96e:	8526                	mv	a0,s1
 970:	70a2                	ld	ra,40(sp)
 972:	7402                	ld	s0,32(sp)
 974:	64e2                	ld	s1,24(sp)
 976:	6942                	ld	s2,16(sp)
 978:	69a2                	ld	s3,8(sp)
 97a:	6a02                	ld	s4,0(sp)
 ...
 984:	0f058593          	addi	a1,a1,240 # a70 <digits+0x28>
 988:	4509                	li	a0,2
 98a:	00000097          	auipc	ra,0x0
 98e:	dc0080e7          	jalr	-576(ra) # 74a <fprintf>
      exit(1);
 992:	4505                	li	a0,1
 994:	00000097          	auipc	ra,0x0
 998:	a7c080e7          	jalr	-1412(ra) # 410 <exit>
