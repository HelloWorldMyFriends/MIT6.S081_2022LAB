...
main(int argc, char **argv)
{
  ...
  4c:	83858593          	addi	a1,a1,-1992 # 880 <statistics+0x90>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d2:	52a50513          	addi	a0,a0,1322 # 8f8 <digits>
 3d6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d6:	3ce70713          	addi	a4,a4,974 # 8a0 <statistics+0xb0>
 ...
 560:	39cb8b93          	addi	s7,s7,924 # 8f8 <digits>
 ...
 5b4:	2e890913          	addi	s2,s2,744 # 898 <statistics+0xa8>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 80a:	10a50513          	addi	a0,a0,266 # 910 <digits+0x18>
 80e:	00000097          	auipc	ra,0x0
 812:	b1c080e7          	jalr	-1252(ra) # 32a <open>
  if(fd < 0) {
 ...
 830:	ad6080e7          	jalr	-1322(ra) # 302 <read>
 ...
 844:	ad2080e7          	jalr	-1326(ra) # 312 <close>
  return i;
}
 848:	8526                	mv	a0,s1
 ...
 85e:	0c658593          	addi	a1,a1,198 # 920 <digits+0x28>
 862:	4509                	li	a0,2
 ...
 872:	a7c080e7          	jalr	-1412(ra) # 2ea <exit>
