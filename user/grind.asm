...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	2b650513          	addi	a0,a0,694 # 1350 <malloc+0xf2>
      a2:	00001097          	auipc	ra,0x1
      a6:	df4080e7          	jalr	-524(ra) # e96 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	2a650513          	addi	a0,a0,678 # 1350 <malloc+0xf2>
      b2:	00001097          	auipc	ra,0x1
      b6:	dec080e7          	jalr	-532(ra) # e9e <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	29c50513          	addi	a0,a0,668 # 1358 <malloc+0xfa>
  ...
  chdir("/");
      ...
      da:	2a250513          	addi	a0,a0,674 # 1378 <malloc+0x11a>
      de:	00001097          	auipc	ra,0x1
      e2:	dc0080e7          	jalr	-576(ra) # e9e <chdir>
      e6:	00001997          	auipc	s3,0x1
      ea:	2a298993          	addi	s3,s3,674 # 1388 <malloc+0x12a>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	29098993          	addi	s3,s3,656 # 1380 <malloc+0x122>
  uint64 iters = 0;
      f8:	4481                	li	s1,0
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	53c90913          	addi	s2,s2,1340 # 1638 <malloc+0x3da>
    ...
    if(what == 1){
     ...
     10e:	28650513          	addi	a0,a0,646 # 1390 <malloc+0x132>
    ...
    if(what == 1){
     ...
     168:	23c50513          	addi	a0,a0,572 # 13a0 <malloc+0x142>
     ...
     182:	21250513          	addi	a0,a0,530 # 1390 <malloc+0x132>
     ...
     194:	1c050513          	addi	a0,a0,448 # 1350 <malloc+0xf2>
     ...
     1a6:	21650513          	addi	a0,a0,534 # 13b8 <malloc+0x15a>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	cd4080e7          	jalr	-812(ra) # e7e <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	1c650513          	addi	a0,a0,454 # 1378 <malloc+0x11a>
     1ba:	00001097          	auipc	ra,0x1
     1be:	ce4080e7          	jalr	-796(ra) # e9e <chdir>
     1c2:	b785                	j	122 <go+0xaa>
        printf("grind: chdir grindir failed\n");
     1c4:	00001517          	auipc	a0,0x1
     1c8:	19450513          	addi	a0,a0,404 # 1358 <malloc+0xfa>
     ...
     1f0:	1d450513          	addi	a0,a0,468 # 13c0 <malloc+0x162>
     ...
     212:	1c250513          	addi	a0,a0,450 # 13d0 <malloc+0x172>
     ...
     256:	13e50513          	addi	a0,a0,318 # 1390 <malloc+0x132>
     25a:	00001097          	auipc	ra,0x1
     25e:	c3c080e7          	jalr	-964(ra) # e96 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	18250513          	addi	a0,a0,386 # 13e8 <malloc+0x18a>
     ...
     282:	17a50513          	addi	a0,a0,378 # 13f8 <malloc+0x19a>
     ...
     294:	17050513          	addi	a0,a0,368 # 1400 <malloc+0x1a2>
     298:	00001097          	auipc	ra,0x1
     29c:	bfe080e7          	jalr	-1026(ra) # e96 <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	16450513          	addi	a0,a0,356 # 1408 <malloc+0x1aa>
     ...
     2c0:	15c50513          	addi	a0,a0,348 # 1418 <malloc+0x1ba>
     ...
     2d2:	11250513          	addi	a0,a0,274 # 13e0 <malloc+0x182>
     2d6:	00001097          	auipc	ra,0x1
     2da:	ba8080e7          	jalr	-1112(ra) # e7e <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	0da58593          	addi	a1,a1,218 # 13b8 <malloc+0x15a>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	13a50513          	addi	a0,a0,314 # 1420 <malloc+0x1c2>
     ...
     2fc:	14050513          	addi	a0,a0,320 # 1438 <malloc+0x1da>
     300:	00001097          	auipc	ra,0x1
     304:	b7e080e7          	jalr	-1154(ra) # e7e <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	0b858593          	addi	a1,a1,184 # 13c0 <malloc+0x162>
     310:	00001517          	auipc	a0,0x1
     314:	13850513          	addi	a0,a0,312 # 1448 <malloc+0x1ea>
     ...
     348:	10c50513          	addi	a0,a0,268 # 1450 <malloc+0x1f2>
     ...
     396:	0be50513          	addi	a0,a0,190 # 1450 <malloc+0x1f2>
     ...
     3f6:	07650513          	addi	a0,a0,118 # 1468 <malloc+0x20a>
     ...
     422:	01250513          	addi	a0,a0,18 # 1430 <malloc+0x1d2>
     ...
     444:	01050513          	addi	a0,a0,16 # 1450 <malloc+0x1f2>
     ...
     45e:	01e50513          	addi	a0,a0,30 # 1478 <malloc+0x21a>
     ...
     4ac:	fa850513          	addi	a0,a0,-88 # 1450 <malloc+0x1f2>
     ...
     508:	f8c50513          	addi	a0,a0,-116 # 1490 <malloc+0x232>
     ...
     534:	f7858593          	addi	a1,a1,-136 # 14a8 <malloc+0x24a>
     ...
     636:	e1e50513          	addi	a0,a0,-482 # 1450 <malloc+0x1f2>
     ...
     650:	ea450513          	addi	a0,a0,-348 # 14f0 <malloc+0x292>
     ...
     664:	e9050513          	addi	a0,a0,-368 # 14f0 <malloc+0x292>
     ...
     67c:	e3058593          	addi	a1,a1,-464 # 14a8 <malloc+0x24a>
     ...
     6c2:	e3250513          	addi	a0,a0,-462 # 14f0 <malloc+0x292>
     6c6:	00000097          	auipc	ra,0x0
     6ca:	7b8080e7          	jalr	1976(ra) # e7e <unlink>
     6ce:	bc91                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     6d0:	00001517          	auipc	a0,0x1
     6d4:	e2850513          	addi	a0,a0,-472 # 14f8 <malloc+0x29a>
     ...
     6ee:	e2650513          	addi	a0,a0,-474 # 1510 <malloc+0x2b2>
     ...
     708:	e2450513          	addi	a0,a0,-476 # 1528 <malloc+0x2ca>
     ...
     724:	e2050513          	addi	a0,a0,-480 # 1540 <malloc+0x2e2>
     ...
     73e:	e2e50513          	addi	a0,a0,-466 # 1568 <malloc+0x30a>
     ...
     826:	de658593          	addi	a1,a1,-538 # 1608 <malloc+0x3aa>
     ...
     84a:	dca50513          	addi	a0,a0,-566 # 1610 <malloc+0x3b2>
     ...
     864:	c3058593          	addi	a1,a1,-976 # 1490 <malloc+0x232>
     868:	4509                	li	a0,2
     ...
     880:	c1458593          	addi	a1,a1,-1004 # 1490 <malloc+0x232>
     884:	4509                	li	a0,2
     ...
     8dc:	cb858593          	addi	a1,a1,-840 # 1590 <malloc+0x332>
     8e0:	4509                	li	a0,2
     ...
     950:	b0458593          	addi	a1,a1,-1276 # 1450 <malloc+0x1f2>
     954:	4509                	li	a0,2
     ...
     99c:	bf858593          	addi	a1,a1,-1032 # 1590 <malloc+0x332>
     9a0:	4509                	li	a0,2
     ...
     9e0:	bb458593          	addi	a1,a1,-1100 # 1590 <malloc+0x332>
     9e4:	4509                	li	a0,2
     ...
     a48:	a0c58593          	addi	a1,a1,-1524 # 1450 <malloc+0x1f2>
     a4c:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	9c450513          	addi	a0,a0,-1596 # 1430 <malloc+0x1d2>
     a74:	00000097          	auipc	ra,0x0
     a78:	40a080e7          	jalr	1034(ra) # e7e <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	96450513          	addi	a0,a0,-1692 # 13e0 <malloc+0x182>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aba:	99a50513          	addi	a0,a0,-1638 # 1450 <malloc+0x1f2>
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b02:	95250513          	addi	a0,a0,-1710 # 1450 <malloc+0x1f2>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f26:	7d650513          	addi	a0,a0,2006 # 16f8 <digits>
     f2a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    102a:	67a70713          	addi	a4,a4,1658 # 16a0 <malloc+0x442>
  ...
  putc(fd, 'x');
    ...
    10b4:	648b8b93          	addi	s7,s7,1608 # 16f8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1108:	59490913          	addi	s2,s2,1428 # 1698 <malloc+0x43a>
        while(*s != 0){
...
malloc(uint nbytes)
{
    ...
    1270:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1272:	02051493          	slli	s1,a0,0x20
    1276:	9081                	srli	s1,s1,0x20
    1278:	04bd                	addi	s1,s1,15
    127a:	8091                	srli	s1,s1,0x4
    127c:	0014899b          	addiw	s3,s1,1
    1280:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12ae:	d6690913          	addi	s2,s2,-666 # 2010 <freep>
  if(p == (char*)-1)
    12b2:	5afd                	li	s5,-1
    12b4:	a895                	j	1328 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    12b6:	00001797          	auipc	a5,0x1
    12ba:	15278793          	addi	a5,a5,338 # 2408 <base>
    ...
    12d6:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12d8:	02071693          	slli	a3,a4,0x20
    12dc:	01c6d713          	srli	a4,a3,0x1c
