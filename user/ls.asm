...
ls(char *path)
{
 ...
 128:	9fc50513          	addi	a0,a0,-1540 # b20 <statistics+0xc2>
 ...
 166:	98e58593          	addi	a1,a1,-1650 # af0 <statistics+0x92>
 16a:	4509                	li	a0,2
 ...
 17c:	99058593          	addi	a1,a1,-1648 # b08 <statistics+0xaa>
 180:	4509                	li	a0,2
 ...
 1ae:	98650513          	addi	a0,a0,-1658 # b30 <statistics+0xd2>
 ...
 1f2:	95aa0a13          	addi	s4,s4,-1702 # b48 <statistics+0xea>
        printf("ls: cannot stat %s\n", buf);
 1f6:	00001a97          	auipc	s5,0x1
 1fa:	912a8a93          	addi	s5,s5,-1774 # b08 <statistics+0xaa>
...
main(int argc, char *argv[])
{
 ...
 2bc:	8a050513          	addi	a0,a0,-1888 # b58 <statistics+0xfa>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 640:	58450513          	addi	a0,a0,1412 # bc0 <digits>
 644:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 744:	42870713          	addi	a4,a4,1064 # b68 <statistics+0x10a>
 ...
 7ce:	3f6b8b93          	addi	s7,s7,1014 # bc0 <digits>
 ...
 822:	34290913          	addi	s2,s2,834 # b60 <statistics+0x102>
        while(*s != 0){
...
statistics(void *buf, int sz)
{
 ...
 a78:	16450513          	addi	a0,a0,356 # bd8 <digits+0x18>
 a7c:	00000097          	auipc	ra,0x0
 a80:	b1c080e7          	jalr	-1252(ra) # 598 <open>
  if(fd < 0) {
 a84:	04054263          	bltz	a0,ac8 <statistics+0x6a>
 a88:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 a8a:	4481                	li	s1,0
 a8c:	03205063          	blez	s2,aac <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 a90:	4099063b          	subw	a2,s2,s1
 a94:	009a05b3          	add	a1,s4,s1
 a98:	854e                	mv	a0,s3
 a9a:	00000097          	auipc	ra,0x0
 a9e:	ad6080e7          	jalr	-1322(ra) # 570 <read>
 aa2:	00054563          	bltz	a0,aac <statistics+0x4e>
      break;
    }
    i += n;
 aa6:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 aa8:	ff24c4e3          	blt	s1,s2,a90 <statistics+0x32>
  }
  close(fd);
 aac:	854e                	mv	a0,s3
 aae:	00000097          	auipc	ra,0x0
 ab2:	ad2080e7          	jalr	-1326(ra) # 580 <close>
  return i;
}
 ab6:	8526                	mv	a0,s1
 ab8:	70a2                	ld	ra,40(sp)
 aba:	7402                	ld	s0,32(sp)
 abc:	64e2                	ld	s1,24(sp)
 abe:	6942                	ld	s2,16(sp)
 ac0:	69a2                	ld	s3,8(sp)
 ac2:	6a02                	ld	s4,0(sp)
 ac4:	6145                	addi	sp,sp,48
 ac6:	8082                	ret
      fprintf(2, "stats: open failed\n");
 ac8:	00000597          	auipc	a1,0x0
 acc:	12058593          	addi	a1,a1,288 # be8 <digits+0x28>
 ad0:	4509                	li	a0,2
 ad2:	00000097          	auipc	ra,0x0
 ad6:	dc0080e7          	jalr	-576(ra) # 892 <fprintf>
      exit(1);
 ada:	4505                	li	a0,1
 adc:	00000097          	auipc	ra,0x0
 ae0:	a7c080e7          	jalr	-1412(ra) # 558 <exit>
