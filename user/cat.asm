...
cat(int fd)
{
  ...
  44:	88058593          	addi	a1,a1,-1920 # 8c0 <malloc+0xee>
  48:	4509                	li	a0,2
  ...
  72:	86a58593          	addi	a1,a1,-1942 # 8d8 <malloc+0x106>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 104:	7f058593          	addi	a1,a1,2032 # 8f0 <malloc+0x11e>
 108:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49a:	4d250513          	addi	a0,a0,1234 # 968 <digits>
 49e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 59e:	37670713          	addi	a4,a4,886 # 910 <malloc+0x13e>
 ...
 628:	344b8b93          	addi	s7,s7,836 # 968 <digits>
 ...
 67c:	29090913          	addi	s2,s2,656 # 908 <malloc+0x136>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 82e:	9e678793          	addi	a5,a5,-1562 # 1210 <base>
